...
public class primedecirconcision
extends JPanel {
    String nomenfant = "";
    String dateenfant = "";
    String numerocheq = "";
    ...
    private void initComponents() {
        ...
        this.jLabel1.setText("Prime de circoncision ");
        this.jPanel1.add(this.jLabel1);
        this.jLabel1.setBounds(120, 20, 410, 33);
        this.jLabel2.setIcon(new ImageIcon(this.getClass().getResource("/prime/hyt.PNG")));
        this.jPanel1.add(this.jLabel2);
        this.jLabel2.setBounds(440, 50, 170, 150);
        ...
        this.mecano.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                primedecirconcision.this.mecanoActionPerformed(evt);
            }
        });
        this.mecano.addKeyListener(new KeyAdapter(){
            ...
            public void keyPressed(KeyEvent evt) {
                primedecirconcision.this.mecanoKeyPressed(evt);
            }

            @Override
            public void keyReleased(KeyEvent evt) {
                primedecirconcision.this.mecanoKeyReleased(evt);
            }
        });
        ...
        this.mont.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedecirconcision.this.montActionPerformed(evt);
            }
        });
        this.mont.addKeyListener(new KeyAdapter(){
            ...
            @Override
            public void keyReleased(KeyEvent evt) {
                primedecirconcision.this.montKeyReleased(evt);
            }
        });
        ...
        this.jLabel5.setText("Nom  de fils :");
        ...
        this.nombebe.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent evt) {
                primedecirconcision.this.nombebeMouseClicked(evt);
            }
        });
        this.nombebe.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedecirconcision.this.nombebeActionPerformed(evt);
            }
        });
        this.nombebe.addKeyListener(new KeyAdapter(){
            ...
            @Override
            public void keyReleased(KeyEvent evt) {
                primedecirconcision.this.nombebeKeyReleased(evt);
            }

            @Override
            public void keyTyped(KeyEvent evt) {
                primedecirconcision.this.nombebeKeyTyped(evt);
            }
        });
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedecirconcision.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.jLabel15.setText("certificat M\u00e9dical");
        ...
        this.jLabel17.setText("de circoncision aff\u00e9rente \u00e0 mon fils ");
        this.jPanel2.add(this.jLabel17);
        this.jLabel17.setBounds(10, 240, 220, 17);
        ...
        this.bebe1.setBounds(230, 230, 310, 30);
        ...
        this.jLabel29.setText("Demande de la prime de circoncision  ");
        ...
        this.jLabel172.setText("tir\u00e9 sur B.T mahdia a titre de prime de circoncision.");
        ...
        this.jTextField43.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedecirconcision.this.jTextField43ActionPerformed(evt);
            }
        });
        ...
        this.d2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedecirconcision.this.d2ActionPerformed(evt);
            }
        });
        ...
        this.jTextField46.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedecirconcision.this.jTextField46ActionPerformed(evt);
            }
        });
        ...
        this.jTextField47.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedecirconcision.this.jTextField47ActionPerformed(evt);
            }
        });
        ...
        this.jTextField49.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedecirconcision.this.jTextField49ActionPerformed(evt);
            }
        });
        ...
        this.jTextField51.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedecirconcision.this.jTextField51ActionPerformed(evt);
            }
        });
        ...
        this.jTextField53.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedecirconcision.this.jTextField53ActionPerformed(evt);
            }
        });
        ...
        this.jTextField55.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedecirconcision.this.jTextField55ActionPerformed(evt);
            }
        });
            ...
            if (k) {
                ...
                if (k) {
                    ...
                    try {
                        ...
                        String type = "prime de circoncision";
                    ...
                    if (k) {
                        ...
                        try {
                            ...
                            state23 = conn4.createStatement();
                            p4 = "1";
                            ResultSet result22 = state23.executeQuery("SELECT * FROM caisseprimemasp  WHERE n='" + p4 + "'");
                            while (result22.next()) {
                        ...
                        try {
                            ...
                            state23 = conn24.createStatement();
                            p4 = "0";
                            state23.executeUpdate("UPDATE caisseprimemasp SET n='0' ");
                            k = true;
                        }
                        catch (Exception e) {
                            k = false;
                        ...
                        try {
                            ...
                            String mm = "" + (total -= tm) + "";
                            state23.executeUpdate("INSERT INTO caisseprimemasp(date,mecano,debit,credit,total,n) VALUES('" + datsystem + "','" + this.mecano.getText() + "','" + this.montt + "','000','" + mm + "','1')");
                            this.mecano.setText("");
                            this.mont.setText("");
                            this.nomadh.setText("...............");
                        }
                    ...
                    if (k) {
                        try {
                            Class.forName("com.mysql.jdbc.Driver");
                            conn23 = DriverManager.getConnection("jdbc:mysql://localhost:3306/sante?useUnicode=true&characterEncoding=UTF-8", "root", "");
                            Statement state24 = conn23.createStatement();
                            k = true;
                            String pv = "1";
                            String mffd = this.mff + "000";
                            state24.executeUpdate("INSERT INTO etatdeschequeprimemasp(Mecano,date,montant,pv,numch) VALUES('" + this.mecano.getText() + "','" + datsystem + "','" + mffd + "','" + pv + "','" + this.firstcheque + "')");
                        }
                        catch (Exception e) {
                            k = false;
                            jop1 = new JOptionPane();
                ...
                try {
                    Class.forName("com.mysql.jdbc.Driver");
                    Connection conn25 = DriverManager.getConnection("jdbc:mysql://localhost:3306/sante?useUnicode=true&characterEncoding=UTF-8", "root", "");
                    Statement state25 = conn25.createStatement();
                    String p5 = "0";
                    this.mecano.setText("");
                    this.mont.setText("");
                    this.nombebe.setText("");
                    this.nomadh.setText("...............");
                    state25.executeUpdate("UPDATE  adherent SET enfant='" + this.nomenfant + "' WHERE MECANO='" + this.mecano.getText() + "'");
                    state25.executeUpdate("UPDATE  adherent SET dateenfant='" + this.dateenfant + "' WHERE MECANO='" + this.mecano.getText() + "'");
                }
                catch (Exception e) {
                    k = false;
