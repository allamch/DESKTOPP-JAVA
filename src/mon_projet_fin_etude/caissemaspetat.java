...
extends JPanel {
    ...
    private void initComponents() {
        ...
        this.jLabel7.setText("Etat Caisse pret ");
        ...
        this.ca.setModel(new DefaultTableModel(new Object[][]{{null, null, null, null, null, null, null, null, null}, {null, null, null, null, null, null, null, null, null}, {null, null, null, null, null, null, null, null, null}, {null, null, null, null, null, null, null, null, null}}, new String[]{"date", "mecano", "N\u00b0 CNR", "Nom et prenom", "Pret", "Prime", "Debit", "Credit", "Total"}){
            Class[] types;
            {
                //super(x0, x1);
                this.types = new Class[]{Object.class, Object.class, Object.class, Object.class, Boolean.class, Boolean.class, Object.class, Object.class, Object.class};
            }
        ...
        this.ca.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent evt) {
                caissemaspetat.this.caMouseClicked(evt);
            }
        });
        ...
        this.jButton4.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                caissemaspetat.this.jButton4ActionPerformed(evt);
            }
        });
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caissemaspetat.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.jButton2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caissemaspetat.this.jButton2ActionPerformed(evt);
            }
        });
        ...
        this.credit.addKeyListener(new KeyAdapter(){
            ...
            public void keyReleased(KeyEvent evt) {
                caissemaspetat.this.creditKeyReleased(evt);
            }
        });
        ...
        this.jToggleButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caissemaspetat.this.jToggleButton1ActionPerformed(evt);
            }
        });
    ...
    private void jButton4ActionPerformed(ActionEvent evt) {
        ...
        MessageFormat header = new MessageFormat("une Copie de l'etat de Caisse ");
    ...
    private void jButton2ActionPerformed(ActionEvent evt) {
        if (this.credit.getText().length() < 5) {
            ...
            try {
                ...
                p = "1";
                ResultSet result2 = state2.executeQuery("SELECT * FROM caissemasp  WHERE n='" + p + "'");
                while (result2.next()) {
            ...
            try {
                ...
                p = "0";
                state2.executeUpdate("UPDATE  caissemasp SET n='0' ");
                this.k = 1;
            }
            catch (Exception e) {
                this.k = 0;
            ...
            try {
                ...
                String mm = "" + (total += tm) + "";
                state2.executeUpdate("INSERT INTO caissemasp(date,mecano,pret,prime,debit,credit,total,n) VALUES('" + datsystem + "','','" + pret + "','" + prime + "','" + prime + "','" + this.credit.getText() + "','" + mm + "','1')");
                this.credit.setText("");
            }
            catch (Exception e) {
                this.k = 0;
            ...
            try {
                ...
                ResultSet result2 = state22.executeQuery("SELECT * FROM caissemasp  ");
                ...
                while (result2.next()) {
                    ...
                    if (pret.equals("1")) {
                        medelo.addRow(new Object[]{date, mecano, NCNR, nom, true, false, debit, credit, totale});
                        ColumnsAutoSizer.sizeColumnsToFit(this.ca);
                    } else if (prime.equals("1")) {
                        medelo.addRow(new Object[]{date, mecano, NCNR, nom, false, true, debit, credit, totale});
                        ColumnsAutoSizer.sizeColumnsToFit(this.ca);
                    } else {
                        medelo.addRow(new Object[]{date, mecano, NCNR, nom, false, false, debit, credit, totale});
                        ColumnsAutoSizer.sizeColumnsToFit(this.ca);
                    }
                    ColumnsAutoSizer.sizeColumnsToFit(this.ca);
                }
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        ...
        try {
            ...
            ResultSet result2 = state2.executeQuery("SELECT * FROM caissemasp  ");
            ResultSetMetaData resultMeta2 = result2.getMetaData();
            System.out.println("------------------------------");
            while (result2.next()) {
                boolean kk = true;
                ...
                if (pret.equals("1")) {
                    medelo.addRow(new Object[]{date, mecano, NCNR, nom, true, false, debit, credit, total});
                    ColumnsAutoSizer.sizeColumnsToFit(this.ca);
                } else if (prime.equals("1")) {
                    medelo.addRow(new Object[]{date, mecano, NCNR, nom, false, true, debit, credit, total});
                    ColumnsAutoSizer.sizeColumnsToFit(this.ca);
                } else {
                    medelo.addRow(new Object[]{date, mecano, NCNR, nom, false, false, debit, credit, total});
                    ColumnsAutoSizer.sizeColumnsToFit(this.ca);
                }
                ColumnsAutoSizer.sizeColumnsToFit(this.ca);
            }
        ...
        if (i > 1) {
            ...
            if (option == 0) {
                ...
                try {
                    ...
                    ResultSet result2 = state2.executeQuery("SELECT MAX(netat) FROM caissemasphistorique  ");
                    System.out.println("------------------------------");
                    if (result2.next()) {
                ...
                SimpleDateFormat dateFormattddc = new SimpleDateFormat("dd/MM/yyyy");
                String dat = dateFormattddc.format(actuellEeddc);
                MessageFormat header = new MessageFormat("Etat de Caisse MASP Tunis N\u00b0" + maxnumetat + " / " + ann\u00e9es);
                MessageFormat footer = new MessageFormat("Page{0,number,integer}");
                try {
                    this.ca.print(JTable.PrintMode.FIT_WIDTH, header, footer);
                }
                ...
                try {
                    ...
                    while (result2.next()) {
                        ...
                        try {
                            ...
                            state.executeUpdate("INSERT INTO caissemasphistorique(date,mecano,pret,prime,debit,credit,total,netat,anne) VALUES('" + date + "','" + mecano + "','" + pret + "','" + prime + "','" + debit + "','" + credit + "','" + total + "','" + maxnumetat + "','" + ann\u00e9es + "')");
                            this.k = 1;
                        }
                        catch (Exception e) {
                            this.k = 0;
                ...
                if (this.k == 1) {
                    try {
                        Statement state = conn2.createStatement();
                        String n = "0";
                        state.executeUpdate("DELETE  FROM caissemasp WHERE n='" + n + "'");
                        try {
                            Class.forName("com.mysql.jdbc.Driver");
                            Statement state2 = conn2.createStatement();
                            state2.executeUpdate("UPDATE  caissemasp SET mecano=''");
                            state2.executeUpdate("UPDATE  caissemasp SET pret='0'");
                            state2.executeUpdate("UPDATE  caissemasp SET prime='0'");
                            state2.executeUpdate("UPDATE  caissemasp SET debit='0'");
                            state2.executeUpdate("UPDATE  caissemasp SET credit='0'");
                            this.k = 1;
                        }
                        catch (Exception e) {
                            this.k = 0;
