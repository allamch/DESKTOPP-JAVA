...
public class caisseFDDrechercheparNum
extends JPanel {
    String ch = "";
    String ch1 = "";
    String t;
    ...
    public caisseFDDrechercheparNum() {
        this.initComponents();
    }
    ...
    private void initComponents() {
        ...
        this.jScrollPane1.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent evt) {
                caisseFDDrechercheparNum.this.jScrollPane1MouseClicked(evt);
            }
        });
        ...
        this.ca.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseFDDrechercheparNum.this.caMouseClicked(evt);
            }

            @Override
            public void mouseEntered(MouseEvent evt) {
                caisseFDDrechercheparNum.this.caMouseEntered(evt);
            }
        });
        this.ca.addAncestorListener(new AncestorListener(){
            ...
            public void ancestorAdded(AncestorEvent evt) {
                caisseFDDrechercheparNum.this.caAncestorAdded(evt);
            }
        ...
        this.jLabel7.setText("Consultation de l'historique de Caisse FDD par N\u00b0");
        this.jPanel16.add(this.jLabel7);
        this.jLabel7.setBounds(40, 0, 680, 30);
        ...
        this.a2.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseFDDrechercheparNum.this.a2MouseClicked(evt);
            }
        });
        ...
        this.a1.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseFDDrechercheparNum.this.a1MouseClicked(evt);
            }
        });
        ...
        this.nn.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseFDDrechercheparNum.this.nnMouseClicked(evt);
            }

            @Override
            public void mouseEntered(MouseEvent evt) {
                caisseFDDrechercheparNum.this.nnMouseEntered(evt);
            }
        });
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                caisseFDDrechercheparNum.this.jButton1ActionPerformed(evt);
            }
        });
    ...
    private void a2MouseClicked(MouseEvent evt) {
        ...
        try {
            ...
            ResultSet result2 = state2.executeQuery("SELECT *  FROM   caisseFDDhistorique WHERE netat BETWEEN " + n1 + " AND " + n2);
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        MessageFormat header = new MessageFormat("historique de caisse fdd  ");
    ...
    private void nnMouseEntered(MouseEvent evt) {
    }
