    ...
    private void initComponents() {
        ...
        this.jTextField4.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                btt.this.jTextField4ActionPerformed(evt);
            }
        });
        ...
        this.jTextField3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                btt.this.jTextField3ActionPerformed(evt);
            }
        });
        ...
        this.jTextField2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                btt.this.jTextField2ActionPerformed(evt);
            }
        });
        ...
        this.jToggleButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                btt.this.jToggleButton1ActionPerformed(evt);
            }
        });
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                btt.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.jButton2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                btt.this.jButton2ActionPerformed(evt);
            }
        });
        ...
        this.jButton3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                btt.this.jButton3ActionPerformed(evt);
            }
        });
