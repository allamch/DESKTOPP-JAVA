...
extends JFrame {
    ...
    private void initComponents() {
        ...
        this.jButton2.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                suppbcvalider.this.jButton2ActionPerformed(evt);
            }
        });
        ...
        this.jButton3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                suppbcvalider.this.jButton3ActionPerformed(evt);
            }
        });
            ...
            try {
                ...
                while (result2.next()) {
                    ...
                    try {
                        ...
                        state3.executeUpdate("INSERT INTO  bandecommandehistorique(Mecano,Matf,nbc,datebc,moisdebut,anneesdebut,accompte,montantbc,montantdevis,nbmois,paimenpar,code,mode,raison,login,Datsupp) VALUES('" + this.mec + "','" + Matfour + "','" + this.num + "','" + datbc + "','" + moidebut + "','" + anndebut + "','" + compt + "','" + montanbc + "','" + montandevis + "','" + nbmois + "','" + paiementpar + "','" + code + "','" + modebc + "','" + this.raison + "','" + this.l.getText() + "','" + datsystem + "')");
                        try {
                            Class.forName("com.mysql.jdbc.Driver");
    ...
    public static void main(String[] args) {
        try {
            ...
            Logger.getLogger(suppbcvalider.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        EventQueue.invokeLater(new Runnable(){
            ...
            @Override
            public void run() {
                new suppbcvalider().setVisible(true);
            }
        });
    }
