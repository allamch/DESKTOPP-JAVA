...
import mon_projet_fin_etude.historiqueprime;
import mon_projet_fin_etude.recherchecarnedecheque;

public class primescolaire
extends JPanel {
    String nomadh = "";
    String ch = "";
    String mont = "";
    ...
    private void initComponents() {
        ...
        this.jLabel1.setText("Prime Scolaire");
        this.jPanel1.add(this.jLabel1);
        this.jLabel1.setBounds(340, 0, 230, 30);
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                primescolaire.this.jButton1ActionPerformed(evt);
            }
        });
        this.jPanel1.add(this.jButton1);
        this.jButton1.setBounds(420, 30, 103, 40);
        ...
        this.jButton7.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primescolaire.this.jButton7ActionPerformed(evt);
            }
        });
        this.jPanel1.add(this.jButton7);
        this.jButton7.setBounds(870, 30, 120, 40);
        ...
        this.mecano.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primescolaire.this.mecanoActionPerformed(evt);
            }
        });
        this.mecano.addKeyListener(new KeyAdapter(){
            ...
            public void keyPressed(KeyEvent evt) {
                primescolaire.this.mecanoKeyPressed(evt);
            }

            @Override
            public void keyReleased(KeyEvent evt) {
                primescolaire.this.mecanoKeyReleased(evt);
            }
        });
        ...
        this.jTextField1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primescolaire.this.jTextField1ActionPerformed(evt);
            }
        });
        ...
        this.jTextField3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primescolaire.this.jTextField3ActionPerformed(evt);
            }
        });
        ...
        this.jTextField5.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primescolaire.this.jTextField5ActionPerformed(evt);
            }
        });
        ...
        this.jTextField7.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primescolaire.this.jTextField7ActionPerformed(evt);
            }
        });
        ...
        this.jTextField9.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primescolaire.this.jTextField9ActionPerformed(evt);
            }
        });
        ...
        this.jScrollPane3.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent evt) {
                primescolaire.this.jScrollPane3MouseClicked(evt);
            }
        });
        ...
        this.ca.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                primescolaire.this.caMouseClicked(evt);
            }

            @Override
            public void mouseEntered(MouseEvent evt) {
                primescolaire.this.caMouseEntered(evt);
            }
        });
        this.ca.addAncestorListener(new AncestorListener(){
            ...
            public void ancestorAdded(AncestorEvent evt) {
                primescolaire.this.caAncestorAdded(evt);
            }
        ...
        this.jButton2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primescolaire.this.jButton2ActionPerformed(evt);
            }
        });
        this.jPanel1.add(this.jButton2);
        this.jButton2.setBounds(640, 30, 230, 40);
        ...
        this.jScrollPane4.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                primescolaire.this.jScrollPane4MouseClicked(evt);
            }
        });
        ...
        this.ca1.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                primescolaire.this.ca1MouseClicked(evt);
            }

            @Override
            public void mouseEntered(MouseEvent evt) {
                primescolaire.this.ca1MouseEntered(evt);
            }
        });
        this.ca1.addAncestorListener(new AncestorListener(){
            ...
            @Override
            public void ancestorAdded(AncestorEvent evt) {
                primescolaire.this.ca1AncestorAdded(evt);
            }
        ...
        this.jScrollPane4.setBounds(10, 330, 370, 210);
        this.jPanel1.add(this.enfant3);
        this.enfant3.setBounds(80, 290, 220, 30);
        this.jLabel10.setFont(new Font("Tahoma", 1, 12));
        this.jLabel10.setForeground(new Color(102, 0, 204));
        this.jLabel10.setText("Nom fils 3:");
        this.jPanel1.add(this.jLabel10);
        this.jLabel10.setBounds(10, 290, 110, 30);
        ...
        this.jButton3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primescolaire.this.jButton3ActionPerformed(evt);
            }
        });
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        ...
        if (kkk == 1) {
            ...
            if (this.enfant3.getText().equals("")) {
                jop2 = new JOptionPane();
                JOptionPane.showMessageDialog(null, "Sasire le nom d'enfant N\u00b03", "Attention", 0);
                this.k = 0;
            }
        }
        if (this.k == 1) {
            try {
                ...
                ResultSet result3 = state3.executeQuery("SELECT * FROM primescolaire  WHERE Mecano=" + this.mecano.getText());
                ...
                while (result3.next()) {
                    ...
                    if (MON == 130) {
                        ...
                        JOptionPane.showMessageDialog(null, "Prime D\u00e9pase 130 D pour l'adherent" + this.nomadh1.getText(), "Attention", 0);
                        continue;
                    }
                    System.out.println("Montant =" + montantp);
                    int MONN = MON + montantprime;
                    if (MONN < 130) continue;
                    System.out.println("MON2 =" + MON);
                    montantprime = 130 - MON;
        ...
        try {
            ...
            Logger.getLogger(primescolaire.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        if (this.k == 1) {
                ...
                try {
                    ...
                    try {
                        ...
                        while (result3.next()) {
                            ...
                            this.cnretat.setText(result3.getString("NCNR"));
                            cnrb = result3.getString("NCNR");
            ...
            try {
                ...
                ResultSet result13 = state3.executeQuery("SELECT nb FROM primescolaire  WHERE anescol='" + anescolb + "' AND MECANO='" + this.mecano.getText() + "'");
                String nbb = "";
            ...
            if (nb >= 3) {
                ...
                JOptionPane.showMessageDialog(null, "n'a pas le droit de prendre un autre prime scolaire pour la 4 eme fils", "Attention", 0);
            }
            int n1 = 0;
            int n2 = 0;
            try {
                ...
                ResultSet result3 = state3.executeQuery("SELECT num FROM primescolaire  WHERE anescol='" + anescolb + "'");
                ResultSetMetaData resultMeta3 = result3.getMetaData();
                this.i = 0;
                while (result3.next()) {
            ...
            if (this.k == 1) {
                ...
                if (option == 0) {
                    ...
                    try {
                        ...
                        String nn = "" + kkk + "";
                        state23.executeUpdate("INSERT INTO primescolaire(MECANO,num,anescol,date,montant,pv,enfant1,enfant2,enfant3,nb,numch,Numetat) VALUES('" + MECANOb + "','" + numb + "','" + anescolb + "','" + dateb + "','" + montantb + "','" + ll + "','" + this.enfant1.getText() + "','" + this.enfant2.getText() + "','" + this.enfant3.getText() + "','" + nn + "','" + this.firstcheque + "','0')");
                        this.k = 1;
                    }
                    catch (Exception e) {
                        jop1 = new JOptionPane();
                    ...
                    if (this.k == 1) {
                        ...
                        try {
                            ...
                            p4 = "1";
                            ResultSet result22 = state24.executeQuery("SELECT * FROM  caisseprimescolaire  WHERE n='" + p4 + "'");
                            while (result22.next()) {
                        ...
                        try {
                            ...
                            p4 = "0";
                            state24.executeUpdate("UPDATE   caisseprimescolaire SET n='0' ");
                            this.k = 1;
                        }
                        catch (Exception e) {
                            this.k = 0;
                        ...
                        try {
                            ...
                            String z = "0";
                            String u = "1";
                            state24.executeUpdate("INSERT INTO  caisseprimescolaire(date,mecano,debit,credit,total,annescoaie,num,n) VALUES('" + datdd + "','" + this.mecano.getText() + "','" + montantb + "','" + z + "','" + mm + "','" + anescolb + "','" + numb + "','" + u + "')");
                        }
                        catch (Exception e) {
                            this.k = 0;
                            jop1 = new JOptionPane();
    ...
    private void jButton7ActionPerformed(ActionEvent evt) {
        historiqueprime a = new historiqueprime();
        a.show();
    }
        ...
        try {
            ...
            if (this.k == 0) {
                ...
                try {
                    ...
                    ResultSet result2 = state2.executeQuery("SELECT *  FROM   primescolaire WHERE anescol='" + anescolb + "' ORDER BY num  ");
                    this.k = 0;
                    int totale = 0;
                    while (result2.next()) {
                        this.k = 1;
                ...
                try {
                    ...
                    ResultSet result2 = state2.executeQuery("SELECT *  FROM   primescolaire WHERE anescol='" + anescolb + "'AND MECANO='" + this.mecano.getText() + "' ORDER BY num  ");
                    this.k = 0;
                    int totale = 0;
                    while (result2.next()) {
                        this.k = 1;
                        ...
                        String enfant3 = result2.getString("enfant3");
                        String Montant = result2.getString("montant");
                        String date = result2.getString("date");
                        totale = Integer.parseInt(Montant) + totale;
                        Montant = new StringBuilder(Montant).insert(Montant.length() - 3, ".").toString();
                        Object[] stg = new Object[]{num, date, enfant1, enfant2, enfant3, Montant};
                        dt2.addRow(stg);
    ...
    private void jButton2ActionPerformed(ActionEvent evt) {
        JOptionPane jop = new JOptionPane();
        int option = JOptionPane.showConfirmDialog(null, "Voulez-vous vraiment terminer l'etat pour?", "Quitter", 0, 3);
        if (option == 0) {
            JOptionPane jop1;
            Connection conn2;
            Statement state2;
            ...
            try {
                Class.forName("com.mysql.jdbc.Driver");
                Statement state3 = conn3.createStatement();
                ResultSet result3 = state3.executeQuery("SELECT \tNumetat FROM primescolaire  WHERE anescol='" + anescolb + "'");
                ResultSetMetaData resultMeta3 = result3.getMetaData();
                this.i = 0;
                while (result3.next()) {
                    String nummm = result3.getString("Numetat");
                    n1 = Integer.parseInt(nummm);
                    if (n1 > n2) {
                        n2 = n1;
                    }
            ...
            try {
                ...
                state2 = conn2.createStatement();
                this.k = 1;
                state2.executeUpdate("INSERT INTO  recapitulationdesetasdeprisscolira(numetata,annescol,dateimprime,montant) VALUES('" + numb + "','" + anescolb + "','" + datddd + "','" + totale + "')");
            }
            catch (Exception e) {
                this.k = 0;
                jop1 = new JOptionPane();
                JOptionPane.showMessageDialog(null, "erreur d'ajout a table recaptilation : " + e.getMessage());
            }
            try {
                Class.forName("com.mysql.jdbc.Driver");
                conn2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/sante?useUnicode=true&characterEncoding=UTF-8", "root", "");
                state2 = conn2.createStatement();
                String p = "0";
                state2.executeUpdate("UPDATE   primescolaire SET Numetat='" + numb + "' WHERE Numetat='0'");
                this.k = 1;
            }
            catch (Exception e) {
                this.k = 0;
                jop1 = new JOptionPane();
                JOptionPane.showMessageDialog(null, "erreur de modification prime scolaire etat: " + e.getMessage());
            }
            MessageFormat header = new MessageFormat("Etat des primes scolaire N\u00b0" + n2 + " Ann\u00e9e:" + anescolb);
            ...
            try {
                ...
                String kl = "0";
                ResultSet result2 = state22.executeQuery("SELECT *  FROM   primescolaire WHERE anescol='" + anescolb + "' AND Numetat='" + kl + "' ORDER BY num  ");
                this.k = 0;
                while (result2.next()) {
                    this.k = 1;
                    String num = result2.getString("num");
                ...
                if (this.k == 1) {
                    mt = "" + totale + "";
                    mt = new StringBuilder(mt).insert(mt.length() - 3, ".").toString() + " DT";
                    Object[] stg = new Object[]{"", "", "", "", "", "Total", mt, ""};
                    dt1.addRow(stg);
                    ColumnsAutoSizer.sizeColumnsToFit(this.ca);
                }
            }
    ...
    private void jButton3ActionPerformed(ActionEvent evt) {
        ...
        try {
            ...
            Statement state2 = conn22.createStatement();
            String kl = "0";
            ResultSet result2 = state2.executeQuery("SELECT *  FROM   primescolaire WHERE anescol='" + anescolb + "' AND Numetat='" + kl + "' ORDER BY num  ");
            this.k = 0;
            int totale = 0;
            while (result2.next()) {
                this.k = 1;
