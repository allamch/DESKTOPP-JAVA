...
extends JPanel {
    ...
    private void initComponents() {
        ...
        this.hotel = new JCheckBox();
        this.prime = new JCheckBox();
        this.jLabel30 = new JLabel();
        this.ad = new JRadioButton();
        this.fils = new JRadioButton();
        this.jLabel31 = new JLabel();
        this.ha = new JTextField();
        ...
        this.jLabel1.setText("Prime de mariage");
        this.jPanel1.add(this.jLabel1);
        this.jLabel1.setBounds(120, 0, 328, 60);
        this.jLabel2.setIcon(new ImageIcon(this.getClass().getResource("/prime/M06-169-d.png")));
        this.jPanel1.add(this.jLabel2);
        this.jLabel2.setBounds(430, 40, 180, 150);
        ...
        this.mecano.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                primedemariage.this.mecanoActionPerformed(evt);
            }
        });
        this.mecano.addKeyListener(new KeyAdapter(){
            ...
            public void keyPressed(KeyEvent evt) {
                primedemariage.this.mecanoKeyPressed(evt);
            }

            @Override
            public void keyReleased(KeyEvent evt) {
                primedemariage.this.mecanoKeyReleased(evt);
            }
        });
        ...
        this.mont.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedemariage.this.montActionPerformed(evt);
            }
        });
        this.mont.addKeyListener(new KeyAdapter(){
            ...
            @Override
            public void keyReleased(KeyEvent evt) {
                primedemariage.this.montKeyReleased(evt);
            }
        });
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedemariage.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.hotel.setFont(new Font("Tahoma", 1, 14));
        this.hotel.setText("Demande d'un sejour \u00e0 l'hotel");
        this.jPanel1.add(this.hotel);
        this.hotel.setBounds(180, 130, 240, 25);
        this.prime.setFont(new Font("Tahoma", 1, 14));
        this.prime.setText("Prime");
        this.jPanel1.add(this.prime);
        this.prime.setBounds(90, 130, 80, 25);
        this.jLabel30.setFont(new Font("Traditional Arabic", 1, 18));
        this.jLabel30.setForeground(new Color(51, 0, 204));
        this.jLabel30.setText("Date de mariage :");
        this.jPanel1.add(this.jLabel30);
        this.jLabel30.setBounds(0, 170, 150, 29);
        this.buttonGroup1.add(this.ad);
        this.ad.setFont(new Font("Tahoma", 1, 14));
        this.ad.setText("Adherant");
        this.jPanel1.add(this.ad);
        this.ad.setBounds(130, 210, 100, 25);
        this.buttonGroup1.add(this.fils);
        this.fils.setFont(new Font("Tahoma", 1, 14));
        this.fils.setText("fils d'adherant");
        this.fils.addActionListener(new ActionListener(){

            @Override
            public void actionPerformed(ActionEvent evt) {
                primedemariage.this.filsActionPerformed(evt);
            }
        });
        this.jPanel1.add(this.fils);
        this.fils.setBounds(230, 210, 130, 25);
        this.jLabel31.setFont(new Font("Traditional Arabic", 1, 18));
        this.jLabel31.setForeground(new Color(51, 0, 204));
        this.jLabel31.setText("Mariage de :");
        this.jPanel1.add(this.jLabel31);
        this.jLabel31.setBounds(0, 210, 120, 29);
        this.ha.addMouseListener(new MouseAdapter(){

            @Override
            public void mouseClicked(MouseEvent evt) {
                primedemariage.this.haMouseClicked(evt);
            }
        });
        this.ha.addActionListener(new ActionListener(){

            @Override
            public void actionPerformed(ActionEvent evt) {
                primedemariage.this.haActionPerformed(evt);
            }
        });
        this.jPanel1.add(this.ha);
        this.ha.setBounds(130, 240, 240, 30);
        this.jLabel32.setFont(new Font("Traditional Arabic", 1, 18));
        this.jLabel32.setForeground(new Color(51, 0, 204));
        this.jLabel32.setText("Lieu de l'hotel :");
        this.jPanel1.add(this.jLabel32);
        this.jLabel32.setBounds(0, 240, 140, 29);
        this.jPanel1.add((Component)this.datebebe);
        this.datebebe.setBounds(160, 160, 200, 30);
        ...
        this.jLabel8.setText("\u00e0 l'occasion de ");
        this.jPanel2.add(this.jLabel8);
        this.jLabel8.setBounds(10, 270, 100, 17);
        ...
        this.jLabel15.setText("Invitation de mariage ou copie de contrat de mariage");
        this.jPanel2.add(this.jLabel15);
        this.jLabel15.setBounds(140, 167, 350, 20);
        this.jLabel16.setFont(new Font("Tahoma", 0, 14));
        this.jLabel16.setText("J'ai l'honneur de venir par la pr\u00e9sente vous demander de bien vouloir me faire b\u00e9n\u00e9fier d'un ");
        ...
        this.nomad2.setBounds(110, 260, 310, 30);
        ...
        this.jTextField43.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedemariage.this.jTextField43ActionPerformed(evt);
            }
        });
        ...
        this.d2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedemariage.this.d2ActionPerformed(evt);
            }
        });
        ...
        this.jTextField46.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedemariage.this.jTextField46ActionPerformed(evt);
            }
        });
        ...
        this.jTextField47.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedemariage.this.jTextField47ActionPerformed(evt);
            }
        });
        ...
        this.jTextField49.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedemariage.this.jTextField49ActionPerformed(evt);
            }
        });
        ...
        this.jTextField51.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedemariage.this.jTextField51ActionPerformed(evt);
            }
        });
        ...
        this.jTextField53.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedemariage.this.jTextField53ActionPerformed(evt);
            }
        });
        ...
        this.jTextField55.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedemariage.this.jTextField55ActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addGap(20, 20, 20).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jPanel1, -2, 610, -2).addComponent(this.jPanel3, -1, 610, 32767)).addContainerGap()));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addComponent(this.jPanel1, -2, 306, -2).addGap(43, 43, 43).addComponent(this.jPanel3, -2, 1438, -2).addContainerGap(-1, 32767)));
    }
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        ...
        if (k) {
            String objet = "";
            if (this.prime.isSelected() && this.hotel.isSelected()) {
                objet = "prime de mariage et Demande de sejour dans un hotel \u00e0 " + this.ha.getText();
            } else if (this.prime.isSelected()) {
                objet = "Prime de mariage";
                k = true;
            } else if (this.hotel.isSelected()) {
                k = true;
                objet = "Demande de sejour dans un hotel \u00e0 " + this.ha.getText();
            } else {
                k = false;
                JOptionPane.showMessageDialog(null, "Selection le mariage de qui ??");
            }
        ...
        if (k) {
            if (this.ad.isSelected()) {
                this.nomad2.setText(" mon mariage le :" + dat);
                k = true;
            } else if (this.fils.isSelected()) {
                k = true;
                this.nomad2.setText(" mon fils le  :" + dat);
            } else {
                k = false;
                JOptionPane.showMessageDialog(null, "Selection le mariage de qui ??");
            }
            ...
            if (k) {
                ...
                if (k) {
                    ...
                    try {
                        ...
                        p = "0";
                        result2 = state23.executeQuery("SELECT * FROM comptecourant  WHERE observation='" + typcarnet + "' AND f='" + p + "'");
                        typena = 1;
                        while (result2.next()) {
                    ...
                    if (deb.equals("")) {
                        try {
                            ...
                            state23 = conn23.createStatement();
                            p = "0";
                            state23.executeUpdate("UPDATE  talondescheque SET p='" + p + "' WHERE p='1'");
                            k = true;
                        }
                        catch (Exception e) {
                            k = false;
                        ...
                        try {
                            ...
                            p = "1";
                            result2 = state23.executeQuery("SELECT * FROM talondescheque  WHERE type='" + typcarnet + "' AND p='" + p + "'");
                            System.out.println("********************************** =");
                            while (result2.next()) {
                        ...
                        if (this.Nfin >= this.Nch) {
                            if (this.Nfin == this.Nch) {
                                try {
                                    ...
                                    state23 = conn23.createStatement();
                                    p = "1";
                                    state23.executeUpdate("UPDATE  comptecourant SET f='" + p + "' WHERE num='" + this.numcarnet + "'");
                            ...
                            if (k) {
                                try {
                                    ...
                                    state22.executeUpdate("INSERT INTO talondescheque(numcheque,Numcarnet,Mecano,Montant,date,type,p,banque) VALUES('" + this.firstcheque + "','" + this.numcarnet + "','" + this.mecano.getText() + "','" + this.montt + "','" + datsystem + "','" + typcarnet + "','" + p3 + "','" + banque + "')");
                                    k = true;
                                }
                                catch (Exception e) {
                                    k = false;
                            ...
                            try {
                                ...
                                result2 = state23.executeQuery("SELECT * FROM comptecourant  WHERE f='" + p + "' AND observation ='" + typcarnet + "'");
                                while (result2.next()) {
                            ...
                            if (this.numcarnetreserver.equals("")) {
                                ...
                                try {
                                    ...
                                    state23 = conn23.createStatement();
                                    p = "0";
                                    state23.executeUpdate("UPDATE  talondescheque SET p='" + p + "' WHERE numcheque='" + this.numerocheq + "'");
                                    k = true;
                                }
                                catch (Exception e) {
                                    k = false;
                    ...
                    if (k) {
                        ...
                        try {
                            ...
                            state22 = conn4.createStatement();
                            p2 = "1";
                            ResultSet result22 = state22.executeQuery("SELECT * FROM caisseprimemasp  WHERE n='" + p2 + "'");
                            while (result22.next()) {
                        ...
                        try {
                            ...
                            state22 = conn2.createStatement();
                            p2 = "0";
                            state22.executeUpdate("UPDATE caisseprimemasp SET n='0' ");
                            k = true;
                        }
                        catch (Exception e) {
                            k = false;
                        ...
                        try {
                            ...
                            String mm = "" + (total -= tm) + "";
                            state22.executeUpdate("INSERT INTO caisseprimemasp(date,mecano,debit,credit,total,n) VALUES('" + datsystem + "','" + this.mecano.getText() + "','" + this.montt + "','000','" + mm + "','1')");
                            this.mecano.setText("");
                            this.mont.setText("");
                            this.nomadh.setText("...............");
                        }
                    ...
                    if (k) {
                        try {
                            ...
                            state2.executeUpdate("INSERT INTO etatdeschequeprimemasp(Mecano,date,montant,pv,numch) VALUES('" + this.mecano.getText() + "','" + datsystem + "','" + mffd + "','" + pv + "','" + this.firstcheque + "')");
                        }
                        catch (Exception e) {
                            k = false;
                            JOptionPane jop1 = new JOptionPane();
    ...
    private void filsActionPerformed(ActionEvent evt) {
    }

    private void haMouseClicked(MouseEvent evt) {
    }

    private void haActionPerformed(ActionEvent evt) {
    }
