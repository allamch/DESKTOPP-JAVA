...
public class paymentdemoisadherant
extends JPanel {
    String nomadh = "";
    String ch = "";
    String mont = "";
    ...
    private void initComponents() {
        ...
        this.mec.addMouseListener(new MouseAdapter(){
            ...
            public void mouseEntered(MouseEvent evt) {
                paymentdemoisadherant.this.mecMouseEntered(evt);
            }
        });
        this.mec.addKeyListener(new KeyAdapter(){
            ...
            public void keyReleased(KeyEvent evt) {
                paymentdemoisadherant.this.mecKeyReleased(evt);
            }
        });
        this.jPanel2.add(this.mec);
        this.mec.setBounds(130, 60, 110, 35);
        this.jButton1.setIcon(new ImageIcon(this.getClass().getResource("/image/gestion cheque/aaa.png")));
        this.jButton1.addActionListener(new ActionListener(){

            @Override
            public void actionPerformed(ActionEvent evt) {
                paymentdemoisadherant.this.jButton1ActionPerformed(evt);
            }
        });
        this.jPanel2.add(this.jButton1);
        this.jButton1.setBounds(630, 60, 50, 30);
        ...
        this.jScrollPane1.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent evt) {
                paymentdemoisadherant.this.jScrollPane1MouseClicked(evt);
            }
        });
        ...
        this.jTable1.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                paymentdemoisadherant.this.jTable1MouseClicked(evt);
            }

            @Override
            public void mouseEntered(MouseEvent evt) {
                paymentdemoisadherant.this.jTable1MouseEntered(evt);
            }
        });
        this.jTable1.addAncestorListener(new AncestorListener(){
            ...
            public void ancestorAdded(AncestorEvent evt) {
                paymentdemoisadherant.this.jTable1AncestorAdded(evt);
            }
        ...
        this.jLabel4.setBounds(30, 60, 83, 35);
        ...
        this.m1.setBounds(350, 60, 60, 30);
        this.jLabel5.setFont(new Font("Tahoma", 1, 18));
        this.jLabel5.setForeground(new Color(153, 0, 153));
        this.jLabel5.setText("mois :");
        this.jPanel2.add(this.jLabel5);
        this.jLabel5.setBounds(280, 60, 60, 35);
        this.a1.setFont(new Font("Tahoma", 1, 14));
        this.jPanel2.add(this.a1);
        this.a1.setBounds(510, 60, 100, 30);
        ...
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addComponent(this.jPanel2, -1, 520, 32767).addContainerGap()));
    }
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        this.nomt.setText(".........................");
        if (this.m1.getSelectedItem().toString().equals("00")) {
            this.nomt.setText("..............................");
            this.ch = this.a1.getText();
            boolean j = false;
            ...
            int aa = Integer.parseInt(this.a1.getText());
            for (int i = 1; i <= 12; ++i) {
                Double totale = 0.0;
                int mm = i;
                ...
                try {
                    ...
                    ResultSet result2 = state2.executeQuery("SELECT *  FROM  bc WHERE Mecano='" + this.mec.getText() + "'");
                    while (result2.next()) {
                        this.k = 1;
            ...
            this.ch = this.m1.getSelectedItem().toString() + "/" + this.a1.getText();
            boolean j = false;
            Double totale = 0.0;
            DefaultTableModel dt1 = new DefaultTableModel();
            ...
            try {
                ...
                Connection conn2 = DriverManager.getConnection("jdbc:mysql://192.168.1.8:3306/cmd?useUnicode=true&characterEncoding=UTF-8", "root", "root");
                Statement state2 = conn2.createStatement();
                ResultSet result2 = state2.executeQuery("SELECT *  FROM  bc1 WHERE MatAD='" + this.mec.getText() + "'");
                int aa = Integer.parseInt(this.a1.getText());
                int mm = Integer.parseInt(this.m1.getSelectedItem().toString());
                while (result2.next()) {
                    this.k = 1;
                    this.nomt.setText(result2.getString("NomAD"));
                    String datedebut = "";
    ...
    private void mecMouseEntered(MouseEvent evt) {
        ...
        if (!kk) {
            ...
            if (this.m1.getSelectedItem().toString().equals("00")) {
                ...
                try {
                    Class.forName("com.mysql.jdbc.Driver");
                    Connection conn22 = DriverManager.getConnection("jdbc:mysql://192.168.1.8:3306/cmd?useUnicode=true&characterEncoding=UTF-8", "root", "root");
                    Statement state2 = conn22.createStatement();
                    ResultSet result2 = state2.executeQuery("SELECT *  FROM  bc WHERE Mecano='" + this.mec.getText() + "'");
                    while (result2.next()) {
                        this.k = 1;
                        this.nomt.setText(result2.getString("NomAD"));
                        int nbm = Integer.parseInt(result2.getString("nbmois"));
                        ...
                        if (!(ad < aa && aa < af || ad == aa && md <= mm && mf >= mm) && (af != aa || mf < mm)) continue;
                        System.out.println("---------------------------");
                        String MAT = result2.getString("matf");
                        String NOMSOC = result2.getString("NOMSOC");
                        String m = result2.getString("Mantmois");
                        System.out.println("montant= " + m);
                        m = m.replace(",", ".");
                ...
                try {
                    Class.forName("com.mysql.jdbc.Driver");
                    Connection conn23 = DriverManager.getConnection("jdbc:mysql://192.168.1.8:3306/cmd?useUnicode=true&characterEncoding=UTF-8", "root", "root");
