...
public class caissemasprechercheparNum
extends JPanel {
    String ch = "";
    String ch1 = "";
    String t;
    ...
    public caissemasprechercheparNum() {
        this.initComponents();
    }
    ...
    private void initComponents() {
        ...
        this.jScrollPane1.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent evt) {
                caissemasprechercheparNum.this.jScrollPane1MouseClicked(evt);
            }
        });
        this.ca.setFont(new Font("Tahoma", 0, 12));
        this.ca.setModel(new DefaultTableModel(new Object[][]{{null, null, null, null, null, null, null, null, null, null, null}, {null, null, null, null, null, null, null, null, null, null, null}, {null, null, null, null, null, null, null, null, null, null, null}, {null, null, null, null, null, null, null, null, null, null, null}, {null, null, null, null, null, null, null, null, null, null, null}}, new String[]{"N\u00b0", "Anne", "Date", "Mecano", "N\u00b0 CNR", "Nom et prenom", "pret", "prime", "Debit", "Credit", "total"}){
            Class[] types;
            {
                //super(x0, x1);
                this.types = new Class[]{Object.class, Object.class, Object.class, String.class, Object.class, Object.class, Boolean.class, Boolean.class, Object.class, Object.class, Object.class};
            }
        ...
        this.ca.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caissemasprechercheparNum.this.caMouseClicked(evt);
            }

            @Override
            public void mouseEntered(MouseEvent evt) {
                caissemasprechercheparNum.this.caMouseEntered(evt);
            }
        });
        this.ca.addAncestorListener(new AncestorListener(){
            ...
            public void ancestorAdded(AncestorEvent evt) {
                caissemasprechercheparNum.this.caAncestorAdded(evt);
            }
        ...
        this.jLabel7.setText("Consultation de l'historique de Caisse Pret MASP par N\u00b0");
        this.jPanel16.add(this.jLabel7);
        this.jLabel7.setBounds(0, 0, 730, 30);
        ...
        this.a2.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caissemasprechercheparNum.this.a2MouseClicked(evt);
            }
        });
        ...
        this.a1.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caissemasprechercheparNum.this.a1MouseClicked(evt);
            }
        });
        ...
        this.nn.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caissemasprechercheparNum.this.nnMouseClicked(evt);
            }
        });
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                caissemasprechercheparNum.this.jButton1ActionPerformed(evt);
            }
        });
    ...
    private void a2MouseClicked(MouseEvent evt) {
        ...
        try {
            ...
            ResultSet result2 = state2.executeQuery("SELECT *  FROM   caissemasphistorique WHERE netat BETWEEN " + n1 + " AND " + n2);
            ...
            while (result2.next()) {
                ...
                if (pret.equals("1")) {
                    medelo.addRow(new Object[]{num, anne, date, mecano, NCNR, nom, true, false, debit, credit, total});
                    ColumnsAutoSizer.sizeColumnsToFit(this.ca);
                } else if (prime.equals("1")) {
                    medelo.addRow(new Object[]{num, anne, date, mecano, NCNR, nom, false, true, debit, credit, total});
                    ColumnsAutoSizer.sizeColumnsToFit(this.ca);
                } else {
                    medelo.addRow(new Object[]{num, anne, date, mecano, NCNR, nom, false, false, debit, credit, total});
                    ColumnsAutoSizer.sizeColumnsToFit(this.ca);
                }
