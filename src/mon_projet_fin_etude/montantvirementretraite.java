...
public class montantvirementretraite
extends JPanel {
    String ch = "";
    String montant = "";
    ...
    public montantvirementretraite() {
        this.initComponents();
    }
    ...
    private void initComponents() {
        ...
        this.jTextField1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                montantvirementretraite.this.jTextField1ActionPerformed(evt);
            }
        });
        ...
        this.jComboBox1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                montantvirementretraite.this.jComboBox1ActionPerformed(evt);
            }
        });
        ...
        this.jScrollPane1.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent evt) {
                montantvirementretraite.this.jScrollPane1MouseClicked(evt);
            }
        });
        ...
        this.jTable1.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                montantvirementretraite.this.jTable1MouseClicked(evt);
            }

            @Override
            public void mouseEntered(MouseEvent evt) {
                montantvirementretraite.this.jTable1MouseEntered(evt);
            }
        });
        this.jTable1.addAncestorListener(new AncestorListener(){
            ...
            public void ancestorAdded(AncestorEvent evt) {
                montantvirementretraite.this.jTable1AncestorAdded(evt);
            }
        ...
        this.jScrollPane1.setBounds(0, 190, 660, 320);
        ...
        this.jButton2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                montantvirementretraite.this.jButton2ActionPerformed(evt);
            }
        });
        ...
        this.imprimer.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                montantvirementretraite.this.imprimerActionPerformed(evt);
            }
        });
        ...
        this.jTextField2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                montantvirementretraite.this.jTextField2ActionPerformed(evt);
            }
        });
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                montantvirementretraite.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.jButton3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                montantvirementretraite.this.jButton3ActionPerformed(evt);
            }
        });
        ...
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addComponent(this.jPanel1, -1, 543, 32767).addContainerGap()));
    }
    ...
    private void jButton2ActionPerformed(ActionEvent evt) {
        ...
        try {
            ...
            System.out.println("**********************************");
            ResultSet result3 = state3.executeQuery("SELECT * FROM retretait  WHERE typbanque='" + this.ch + "'");
                ...
                try {
                    ...
                    while (result3.next()) {
                        ...
                        try {
                            ...
                            state2.executeUpdate("INSERT INTO etatvirmentr(mois,banque,montant,MECANO,nom) VALUES('" + dateS + "','" + this.ch + "','" + this.montant + "','" + nd + "','" + nomadh + "')");
                        }
                        catch (Exception e) {
                        ...
                        try {
                            ...
                            stat.executeUpdate("UPDATE retretait SET nbm='" + b + "' WHERE mecano='" + n + "'");
                        }
                        catch (Exception e) {
                            jop3 = new JOptionPane();
        ...
        if (this.jTextField1.getText().equals("") || this.jTextField2.getText().equals("")) {
            ...
            if (b) {
                ...
                try {
                    ...
                    ResultSet result3 = state.executeQuery("SELECT * FROM retretait  WHERE mecano='" + this.jTextField1.getText() + "'");
                    while (result3.next()) {
                        String nbv = result3.getString("nbm");
                        int n = Integer.parseInt(nbv);
                        ...
                        if (n > 0) {
                            try {
                                ...
                                Statement state2 = conn22.createStatement();
                                state2.executeUpdate("UPDATE retretait SET montant='" + this.jTextField2.getText() + "' WHERE mecano=" + this.jTextField1.getText());
                                state2.executeUpdate("UPDATE retretait SET typbanque='" + this.ch + "' WHERE mecano=" + this.jTextField1.getText());
                                int fin = 1;
                                state2.executeUpdate("UPDATE retretait SET fin='" + fin + "' WHERE mecano=" + this.jTextField1.getText());
