...
extends JPanel {
    ...
    private void initComponents() {
        ...
        this.jLabel2.setText("le mode de recherche :");
        this.jPanel1.add(this.jLabel2);
        this.jLabel2.setBounds(20, 140, 160, 20);
        ...
        this.jLabel3.setBounds(210, 80, 130, 20);
        ...
        this.jScrollPane1.setBounds(10, 170, 750, 360);
        this.mo.addActionListener(new ActionListener(){

            @Override
            public void actionPerformed(ActionEvent evt) {
                etatdecession.this.moActionPerformed(evt);
            }
        });
        this.jPanel1.add(this.mo);
        this.mo.setBounds(300, 70, 140, 30);
        ...
        this.etat.setBounds(50, 180, 620, 340);
        this.jPanel4.setCursor(new Cursor(0));
        this.jPanel4.setEnabled(false);
        this.jPanel4.setFocusCycleRoot(true);
        ...
        this.tunis.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatdecession.this.tunisActionPerformed(evt);
            }
        });
        ...
        jPanel4Layout.setHorizontalGroup(jPanel4Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel4Layout.createSequentialGroup().addContainerGap().addComponent(this.tunis).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.mahdia).addContainerGap(16, 32767)));
        ...
        this.jPanel4.setBounds(180, 110, 150, 30);
        ...
        this.jLabel15.setBounds(20, 110, 150, 20);
        ...
        jPanel5Layout.setHorizontalGroup(jPanel5Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel5Layout.createSequentialGroup().addGap(8, 8, 8).addComponent(this.tous).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.encore, -2, 206, -2).addContainerGap(-1, 32767)));
        jPanel5Layout.setVerticalGroup(jPanel5Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel5Layout.createSequentialGroup().addGroup(jPanel5Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.encore).addComponent(this.tous)).addContainerGap(-1, 32767)));
        this.jPanel1.add(this.jPanel5);
        this.jPanel5.setBounds(180, 140, 270, 30);
        ...
        this.jLabel17.setBounds(20, 80, 200, 20);
        this.jComboBox1.setFont(new Font("Tahoma", 1, 12));
        this.jComboBox1.setModel(new DefaultComboBoxModel<String>(new String[]{"Cession normale", "Fourniseur", "Etat FDD", "Etat cession", "Tous", " "}));
        this.jPanel1.add(this.jComboBox1);
        this.jComboBox1.setBounds(120, 40, 160, 30);
        this.jLabel7.setFont(new Font("Tahoma", 1, 24));
        this.jLabel7.setText("Etat des Cessions");
        this.jPanel1.add(this.jLabel7);
        this.jLabel7.setBounds(270, 0, 380, 29);
        ...
        this.Mecano1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatdecession.this.Mecano1ActionPerformed(evt);
            }
        });
        ...
        this.Mecano.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatdecession.this.MecanoActionPerformed(evt);
            }
        });
        ...
        this.jTextField11.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatdecession.this.jTextField11ActionPerformed(evt);
            }
        });
        ...
        this.jTextField14.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatdecession.this.jTextField14ActionPerformed(evt);
            }
        });
        ...
        this.jTextField15.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatdecession.this.jTextField15ActionPerformed(evt);
            }
        });
        ...
        this.jTextField18.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatdecession.this.jTextField18ActionPerformed(evt);
            }
        });
        ...
        this.jTextField19.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatdecession.this.jTextField19ActionPerformed(evt);
            }
        });
        ...
        this.ne4.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatdecession.this.ne4ActionPerformed(evt);
            }
        });
        ...
        this.ne9.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatdecession.this.ne9ActionPerformed(evt);
            }
        });
        ...
        this.ne10.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatdecession.this.ne10ActionPerformed(evt);
            }
        });
        ...
        this.jLabel16.setIcon(new ImageIcon(this.getClass().getResource("/image/mutuelle/ENTET.PNG")));
        this.jPanel3.add(this.jLabel16);
        this.jLabel16.setBounds(50, 10, 550, 40);
        this.jLabel18.setFont(new Font("Tahoma", 1, 14));
        this.jLabel18.setText("A accr\u00e9diter de compter");
        this.jPanel3.add(this.jLabel18);
        this.jLabel18.setBounds(220, 100, 180, 20);
        ...
        this.ne13.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatdecession.this.ne13ActionPerformed(evt);
            }
        });
        ...
        this.jTextField20.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatdecession.this.jTextField20ActionPerformed(evt);
            }
        });
        ...
        this.jPanel3.setBounds(43, 667, 610, 190);
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatdecession.this.jButton1ActionPerformed(evt);
            }
        });
        this.jPanel1.add(this.jButton1);
        this.jButton1.setBounds(570, 90, 160, 30);
        ...
        this.jButton3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatdecession.this.jButton3ActionPerformed(evt);
            }
        });
        this.jPanel1.add(this.jButton3);
        this.jButton3.setBounds(570, 130, 160, 30);
        GroupLayout layout = new GroupLayout(this);
        this.setLayout(layout);
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addContainerGap(-1, 32767).addComponent(this.jPanel1, -2, 766, -2).addGap(82, 82, 82)));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap(-1, 32767).addComponent(this.jPanel1, -2, 541, -2)));
    }
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
                    ...
                    if (g) {
                        ...
                        if (minist\u00e9re == 1) {
                            try {
                                ...
                                dt12 = new DefaultTableModel();
                                dt12.addColumn("Num");
                                dt12.addColumn("N\u00b0 C.N.R");
                                dt12.addColumn("Nom et prenom");
                                dt12.addColumn("Reference");
                                dt12.addColumn("Rabais Mensuel");
                                dt12.addColumn("Montant");
                                dt12.addColumn("Date d\u00e9but");
                                dt12.addColumn("Date fin");
                                dt12.addColumn("N\u00b0 Mecano");
                                dt12.addColumn("Remarque");
                                this.Table_Empoyee.setModel(dt12);
                                dat = this.mo.getText();
                                ...
                                result32 = state.executeQuery("SELECT * FROM cession2  WHERE premiermois='" + this.moiactueleenlettre + "'");
                                k = 0;
                                while (result32.next()) {
                                    ++k;
                                    String cnr2 = "";
                                    ...
                                    ref = result32.getString("ref");
                                    mparmois = result32.getString("montantparmois");
                                    mparmois = mparmois.substring(0, mparmois.length() - 4);
                                    total = result32.getString("Montant");
                                    total = total.substring(0, total.length() - 3);
                                    nb = result32.getString("Nbmois");
                                    pm = result32.getString("premiermois");
                                    dm = result32.getString("derniermois");
                                    String mpm3 = result32.getString("montantparmois");
                                    Object[] stg5 = new Object[]{k, cnr2, Nom, ref, mparmois, total, pm, dm, mecano};
                                    dt12.addRow(stg5);
                                }
                                if (k == 0) {
                            ...
                            try {
                                ...
                                while (result32.next()) {
                                    ...
                                    try {
                                        Class.forName("com.mysql.jdbc.Driver");
                                        Statement state3 = conn2.createStatement();
                                        ResultSet result42 = state3.executeQuery("SELECT * FROM   adherent WHERE MECANO=" + mecano);
                                        while (result42.next()) {
                                            travaille = result42.getString("TRVAIL");
                                            lieutrvaille = result42.getString("LIEUTRAVAIL");
                                    ...
                                    int j = lieutrvaille.indexOf("TAHAR");
                                    if (!travaille.equals("Ouvrier") || j == -1) continue;
                                    String Nom3 = result32.getString("Nom");
                                    String ref3 = result32.getString("ref");
                                    String mparmois3 = result32.getString("montantparmois");
                                    mparmois3 = mparmois3.substring(0, mparmois3.length() - 4);
                                    total3 = result32.getString("Montant");
                                    total3 = total3.substring(0, total3.length() - 3);
                                    nb3 = result32.getString("Nbmois");
                                    pm3 = result32.getString("premiermois");
                                    dm3 = result32.getString("derniermois");
                                    mpm = result32.getString("montantparmois");
                                    k2 = 1;
                                    stg3 = new Object[]{k2, cnr3, Nom3, ref3, mparmois3, total3, pm3, dm3, mecano};
                                    dt12.addRow(stg3);
                                }
                            }
                            catch (Exception e) {
                        ...
                        if (minist\u00e9re == 1) {
                            try {
                                ...
                                this.dateetanne.setText(this.moiactueleenlettre + "");
                                ii = "0";
                                ResultSet result33 = state.executeQuery("SELECT * FROM cession2  WHERE premiermois='" + this.moiactueleenlettre + "' AND i='" + ii + "'");
                                int k3 = 0;
                                while (result33.next()) {
                                    ++k3;
                                    cnr = "";
                                    mecano2 = result33.getString("Mecano");
                                    lieutrvaille2 = "";
                                    String travaille2 = "";
                                    try {
                                        Class.forName("com.mysql.jdbc.Driver");
                                        Statement state3 = conn2.createStatement();
                                        ResultSet result43 = state3.executeQuery("SELECT * FROM   adherent WHERE MECANO=" + mecano2);
                                        while (result43.next()) {
                                            travaille2 = result43.getString("TRVAIL");
                                            lieutrvaille2 = result43.getString("LIEUTRAVAIL");
                                    ...
                                    mpm2 = result33.getString("montantparmois");
                                    stg4 = new Object[]{k3, cnr, Nom2, ref2, mparmois2, total2, pm2, dm2, mecano2};
                                    dt12.addRow(stg4);
                                }
                                if (k3 == 0) {
                            ...
                            try {
                                ...
                                while (result32.next()) {
                                    ...
                                    try {
                                        Class.forName("com.mysql.jdbc.Driver");
                                        Statement state3 = conn2.createStatement();
                                        ResultSet result44 = state3.executeQuery("SELECT * FROM   adherent WHERE MECANO=" + mecano);
                                        while (result44.next()) {
                                            travaille = result44.getString("TRVAIL");
                                            lieutrvaille = result44.getString("LIEUTRAVAIL");
                                    ...
                                    int j = lieutrvaille.indexOf("TAHAR");
                                    if (!travaille.equals("Ouvrier") || j == -1) continue;
                                    String Nom4 = result32.getString("Nom");
                                    String ref4 = result32.getString("ref");
                                    String mparmois4 = result32.getString("montantparmois");
                                    ...
                                    dm3 = result32.getString("derniermois");
                                    mpm = result32.getString("montantparmois");
                                    stg3 = new Object[]{k4, cnr4, Nom4, ref4, mparmois4, total3, pm3, dm3, mecano};
                                    dt12.addRow(stg3);
                                }
                                if (k4 == 0) {
                    ...
                    if (g) {
                        ...
                        if (minist\u00e9re == 1) {
                            try {
                                ...
                                this.moiactueleenlettre = this.moiactueleenlettre + "  " + anneactuel;
                                this.dateetanne.setText(this.moiactueleenlettre + "");
                                result32 = state.executeQuery("SELECT * FROM cessionfournisseur  WHERE premiermois='" + this.moiactueleenlettre + "'");
                                k = 0;
                                while (result32.next()) {
                                    ++k;
                                    cnr5 = "";
                                    ...
                                    try {
                                        Class.forName("com.mysql.jdbc.Driver");
                                        Statement state3 = conn2.createStatement();
                                        ResultSet result45 = state3.executeQuery("SELECT * FROM   adherent WHERE MECANO=" + mecano);
                                        while (result45.next()) {
                                            travaille = result45.getString("TRVAIL");
                                            lieutrvaille = result45.getString("LIEUTRAVAIL");
                                    ...
                                    pm = result32.getString("premiermois");
                                    dm = result32.getString("derniermois");
                                    stg = new Object[]{k, cnr5, Nom, ref, mparmois, total, pm, dm, mecano};
                                    dt12.addRow(stg);
                                }
                                if (k == 0) {
                            ...
                            try {
                                ...
                                while (result32.next()) {
                                    ...
                                    ref5 = result32.getString("ref");
                                    mparmois5 = result32.getString("montantparmois");
                                    ...
                                    dm3 = result32.getString("derniermois");
                                    mpm = result32.getString("montantparmois");
                                    stg3 = new Object[]{k, cnr5, Nom5, ref5, mparmois5, total3, pm3, dm3, mecano};
                                    dt12.addRow(stg3);
                                }
                                if (k == 0) {
                                    jop27 = new JOptionPane();
                        ...
                        if (minist\u00e9re == 1) {
                            try {
                                ...
                                this.dateetanne.setText(this.moiactueleenlettre + "");
                                ii = "0";
                                ResultSet result34 = state.executeQuery("SELECT * FROM cessionfournisseur  WHERE premiermois='" + this.moiactueleenlettre + "' AND i='" + ii + "'");
                                int k5 = 0;
                                while (result34.next()) {
                                    ++k5;
                                    cnr = "";
                                    mecano2 = result34.getString("Mecano");
                                    lieutrvaille2 = "";
                                    String travaille3 = "";
                                    try {
                                        Class.forName("com.mysql.jdbc.Driver");
                                        Statement state3 = conn2.createStatement();
                                        ResultSet result46 = state3.executeQuery("SELECT * FROM   adherent WHERE MECANO=" + mecano2);
                                        while (result46.next()) {
                                            travaille3 = result46.getString("TRVAIL");
                                            lieutrvaille2 = result46.getString("LIEUTRAVAIL");
                                    ...
                                    ref2 = result34.getString("ref");
                                    mparmois2 = result34.getString("montantparmois");
                                    mparmois2 = mparmois2.substring(0, mparmois2.length() - 4);
                                    total2 = result34.getString("Montant");
                                    total2 = total2.substring(0, total2.length() - 3);
                                    nb2 = result34.getString("Nbmois");
                                    pm2 = result34.getString("premiermois");
                                    dm2 = result34.getString("derniermois");
                                    mpm2 = result34.getString("montantparmois");
                                    stg4 = new Object[]{k5, cnr, Nom2, ref2, mparmois2, total2, pm2, dm2, mecano2};
                                    dt12.addRow(stg4);
                                }
                                if (k5 == 0) {
                                    jop23 = new JOptionPane();
                            ...
                            try {
                                ...
                                while (result32.next()) {
                                    ...
                                    try {
                                        ...
                                        result4 = state.executeQuery("SELECT * FROM   adherent WHERE MECANO=" + mecano);
                                        while (result4.next()) {
                                            travaille = result4.getString("TRVAIL");
                                            lieutrvaille = result4.getString("LIEUTRAVAIL");
                                            cnr5 = result4.getString("NCNR");
        ...
        if (this.jComboBox1.getSelectedItem().equals("Etat FDD")) {
            ...
            try {
                Class.forName("com.mysql.jdbc.Driver");
                state = conn2.createStatement();
                ResultSet result35 = state.executeQuery("SELECT * FROM demandefdd ");
                //boolean k = false;
                while (result35.next()) {
                    JOptionPane jop39;
                    System.out.println("------------");
                    String num = result35.getString("nbch");
                    String date = result35.getString("date");
                    String Mecano = result35.getString("Mecano");
                    String Montant = result35.getString("Montant");
                    String datedebut = result35.getString("datedebut");
                    String datefin = result35.getString("datefin");
                    n = false;
                    try {
                        Class.forName("com.mysql.jdbc.Driver");
                        Statement state4 = conn2.createStatement();
                         result4 = state4.executeQuery("SELECT * FROM adherent WHERE MECANO='" + Mecano + "'");
                        while (result4.next()) {
                            System.out.println("------------");
                    ...
                    if (!n) {
                        try {
                            ...
                            ResultSet result5 = state5.executeQuery("SELECT * FROM retretait WHERE mecano='" + Mecano + "'");
                            while (result5.next()) {
                                System.out.println("------------");
                                nom = result5.getString("nom");
                                type = "R";
                                n = true;
                            }
                        }
                    ...
                    stg2 = new Object[]{num, date, Mecano, nom, Montant, datedebut, datefin, type};
                    dt1.addRow(stg2);
                }
            }
            catch (Exception e) {
        ...
        if (this.jComboBox1.getSelectedItem().equals("Etat cession")) {
            dt1 = new DefaultTableModel();
            dt1.addColumn("N\u00b0");
            dt1.addColumn("Date");
            dt1.addColumn("Mecano");
            ...
            try {
                ...
                result3 = state2.executeQuery("SELECT * FROM cession2  WHERE annenbc='" + this.mo.getText() + "'");
                //boolean k = false;
                while (result3.next()) {
                    System.out.println("------------");
                    ...
                    String datedebut = result3.getString("premiermois");
                    String datefin = result3.getString("derniermois");
                    String montantparmois = result3.getString("montantparmois");
                    n = false;
                    stg2 = new Object[]{num, date, Mecano, nom, Montant, datedebut, datefin, montantparmois};
                    dt1.addRow(stg2);
                }
            }
            catch (Exception e) {
        ...
        if (this.jComboBox1.getSelectedItem().equals("Tous")) {
            ...
            try {
                Class.forName("com.mysql.jdbc.Driver");
                Statement state3 = conn2.createStatement();
                result3 = state3.executeQuery("SELECT * FROM cession2 ");
                 k = 0;
                while (result3.next()) {
                    System.out.println("------------");
                    ...
                    try {
                        ...
                        Statement state32 = conn2.createStatement();
                         result4 = state32.executeQuery("SELECT * FROM   adherent WHERE MECANO=" + mecano);
                        while (result4.next()) {
                        ...
                        if (minist\u00e9re == 1) {
                            ...
                            try {
                                ...
                                while (ll) {
                                    ...
                                    while (result3.next()) {
                                        ll = true;
                                        String bi = result3.getString("i");
                                        if (bi.equals("1") || i >= 15) continue;
                                        ...
                                        try {
                                            k = 1;
                                            Class.forName("com.mysql.jdbc.Driver");
                                            System.out.println("jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjiiiiiiiiiiiiiiiiiiiiiiiii111111111");
                                            ...
                                            String lk = "1";
                                            System.out.println("jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjiiiiiiiiiiiiiiiiiiiiiiiii22222222222");
                                            statem.executeUpdate("UPDATE cession2 SET i='" + lk + "' WHERE MECANO='" + mec + "' AND ref='" + ref + "'");
                                        }
                                        catch (Exception e) {
                                            k = 0;
                                            JOptionPane jop3 = new JOptionPane();
