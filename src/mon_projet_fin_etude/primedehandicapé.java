...
extends JPanel {
    ...
    private void initComponents() {
        ...
        this.conjoint = new JRadioButton();
        ...
        this.jLabel1.setText("Prime  d'handicap\u00e9");
        this.jPanel1.add(this.jLabel1);
        this.jLabel1.setBounds(120, 20, 328, 33);
        this.jLabel2.setIcon(new ImageIcon(this.getClass().getResource("/prime/ki.png")));
        this.jPanel1.add(this.jLabel2);
        this.jLabel2.setBounds(400, 50, 200, 150);
        ...
        this.mecano.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                primedehandicap\u00e9.this.mecanoActionPerformed(evt);
            }
        });
        this.mecano.addKeyListener(new KeyAdapter(){
            ...
            public void keyPressed(KeyEvent evt) {
                primedehandicap\u00e9.this.mecanoKeyPressed(evt);
            }

            @Override
            public void keyReleased(KeyEvent evt) {
                primedehandicap\u00e9.this.mecanoKeyReleased(evt);
            }
        });
        ...
        this.mont.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedehandicap\u00e9.this.montActionPerformed(evt);
            }
        });
        this.mont.addKeyListener(new KeyAdapter(){
            ...
            @Override
            public void keyReleased(KeyEvent evt) {
                primedehandicap\u00e9.this.montKeyReleased(evt);
            }
        });
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedehandicap\u00e9.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.ad.setBounds(90, 170, 100, 25);
        this.buttonGroup1.add(this.fils);
        this.fils.setFont(new Font("Tahoma", 1, 14));
        this.fils.setText("Fils ");
        this.jPanel1.add(this.fils);
        this.fils.setBounds(300, 170, 60, 25);
        this.jLabel5.setFont(new Font("Tahoma", 1, 14));
        this.jLabel5.setForeground(new Color(51, 0, 204));
        this.jLabel5.setText("Prime :");
        this.jPanel1.add(this.jLabel5);
        this.jLabel5.setBounds(20, 170, 70, 30);
        this.buttonGroup1.add(this.jb);
        this.jb.setText("jRadioButton3");
        this.jPanel1.add(this.jb);
        this.jb.setBounds(270, 170, 0, 23);
        this.buttonGroup1.add(this.conjoint);
        this.conjoint.setFont(new Font("Tahoma", 1, 14));
        this.conjoint.setText("conjoint");
        this.jPanel1.add(this.conjoint);
        this.conjoint.setBounds(200, 170, 90, 25);
        ...
        this.jLabel15.setText("Copie carte handicap\u00e9");
        this.jPanel2.add(this.jLabel15);
        this.jLabel15.setBounds(140, 170, 230, 20);
        ...
        this.jLabel17.setText("d'handicap\u00e9 aff\u00e9rente \u00e0 ");
        this.jPanel2.add(this.jLabel17);
        this.jLabel17.setBounds(10, 240, 160, 17);
        ...
        this.nomad.setText(".............................");
        this.jPanel2.add(this.nomad);
        this.nomad.setBounds(170, 230, 360, 30);
        ...
        this.jLabel29.setText("Demande de la prime d'handicap\u00e9 ");
        ...
        this.jLabel172.setText("tir\u00e9 sur B.T mahdia a titre de prime d'handicap\u00e9.");
        ...
        this.jTextField43.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedehandicap\u00e9.this.jTextField43ActionPerformed(evt);
            }
        });
        ...
        this.d2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedehandicap\u00e9.this.d2ActionPerformed(evt);
            }
        });
        ...
        this.jTextField46.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedehandicap\u00e9.this.jTextField46ActionPerformed(evt);
            }
        });
        ...
        this.jTextField47.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedehandicap\u00e9.this.jTextField47ActionPerformed(evt);
            }
        });
        ...
        this.jTextField49.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedehandicap\u00e9.this.jTextField49ActionPerformed(evt);
            }
        });
        ...
        this.jTextField51.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedehandicap\u00e9.this.jTextField51ActionPerformed(evt);
            }
        });
        ...
        this.jTextField53.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedehandicap\u00e9.this.jTextField53ActionPerformed(evt);
            }
        });
        ...
        this.jTextField55.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primedehandicap\u00e9.this.jTextField55ActionPerformed(evt);
            }
        });
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        ...
        if (k) {
            if (this.ad.isSelected()) {
                this.nomad.setText(" moi meme");
            } else if (this.fils.isSelected()) {
                this.nomad.setText(" mon fils");
            } else if (this.conjoint.isSelected()) {
                this.nomad.setText(" mon conjoint");
            }
        }
        if (k) {
            JOptionPane jop = new JOptionPane();
            int option = JOptionPane.showConfirmDialog(null, "Attention :voulez vouz vraiment imprimer un prime de" + this.mont.getText() + ")", "Attention", 0, 3);
            if (option == 0) {
                k = true;
            }
            if (k) {
                ...
                if (k) {
                    ...
                    if (k) {
                        ...
                        try {
                            ...
                            String type = "prime de handicap\u00e9";
