...
public class caisseFDDrecherchepardat
extends JPanel {
    String ch = "";
    String ch1 = "";
    String t;
    ...
    public caisseFDDrecherchepardat() {
        this.initComponents();
    }
    ...
    private void initComponents() {
        ...
        this.jScrollPane1.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent evt) {
                caisseFDDrecherchepardat.this.jScrollPane1MouseClicked(evt);
            }
        });
        ...
        this.ca.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseFDDrecherchepardat.this.caMouseClicked(evt);
            }

            @Override
            public void mouseEntered(MouseEvent evt) {
                caisseFDDrecherchepardat.this.caMouseEntered(evt);
            }
        });
        this.ca.addAncestorListener(new AncestorListener(){
            ...
            public void ancestorAdded(AncestorEvent evt) {
                caisseFDDrecherchepardat.this.caAncestorAdded(evt);
            }
        ...
        this.jLabel7.setText("Consultation de l'historique de Caisse FDD par date ");
        this.jPanel16.add(this.jLabel7);
        this.jLabel7.setBounds(30, 0, 680, 30);
        ...
        this.m1.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseFDDrecherchepardat.this.m1MouseClicked(evt);
            }
        });
        this.m1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                caisseFDDrecherchepardat.this.m1ActionPerformed(evt);
            }
        });
        ...
        this.m2.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseFDDrecherchepardat.this.m2MouseClicked(evt);
            }

            @Override
            public void mouseEntered(MouseEvent evt) {
                caisseFDDrecherchepardat.this.m2MouseEntered(evt);
            }
        });
        ...
        this.a2.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseFDDrecherchepardat.this.a2MouseClicked(evt);
            }
        });
        ...
        this.a1.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseFDDrecherchepardat.this.a1MouseClicked(evt);
            }
        });
        ...
        this.j2.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseFDDrecherchepardat.this.j2MouseClicked(evt);
            }
        });
        ...
        this.j1.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseFDDrecherchepardat.this.j1MouseClicked(evt);
            }
        });
        ...
        this.jTextField2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caisseFDDrecherchepardat.this.jTextField2ActionPerformed(evt);
            }
        });
        ...
        this.dd.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseFDDrecherchepardat.this.ddMouseClicked(evt);
            }
        });
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caisseFDDrecherchepardat.this.jButton1ActionPerformed(evt);
            }
        });
    ...
    private void m1MouseClicked(MouseEvent evt) {
        if (this.dd.isSelected()) {
            ...
            try {
                ...
                ResultSet result2 = state2.executeQuery("SELECT *  FROM   caisseFDDhistorique ");
