...
public class caissepretetatdecheque
extends JPanel {
    String ch = "";
    String ch1 = "";
    String t;
    ...
    private void initComponents() {
        ...
        this.jLabel7.setText("Etat des cheques Pret");
        this.jPanel16.add(this.jLabel7);
        this.jLabel7.setBounds(250, 0, 430, 30);
        ...
        this.ca.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent evt) {
                caissepretetatdecheque.this.caMouseClicked(evt);
            }
        });
        ...
        this.jButton4.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                caissepretetatdecheque.this.jButton4ActionPerformed(evt);
            }
        });
        ...
        this.jButton2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caissepretetatdecheque.this.jButton2ActionPerformed(evt);
            }
        });
        ...
        this.tous.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caissepretetatdecheque.this.tousMouseClicked(evt);
            }
        });
        ...
        this.valider.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caissepretetatdecheque.this.validerMouseClicked(evt);
            }

            @Override
            public void mouseEntered(MouseEvent evt) {
                caissepretetatdecheque.this.validerMouseEntered(evt);
            }
        });
        ...
        this.nonvalider.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caissepretetatdecheque.this.nonvaliderMouseClicked(evt);
            }
        });
        this.nonvalider.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caissepretetatdecheque.this.nonvaliderActionPerformed(evt);
            }
        });
        ...
        if (this.nonvalider.isSelected()) {
            ...
            for (int i = 0; i < this.ca.getRowCount(); ++i) {
                ...
                try {
                    ...
                    pp = "0";
                    state2.executeUpdate("UPDATE   etatdeschequepretmasp SET pv='" + pp + "' WHERE numch='" + numch + "'");
                ...
                try {
                    ...
                    state2 = conn2.createStatement();
                    pp = "0";
                    state2.executeUpdate("UPDATE   etatdeschequepretmasp SET numGL='" + numGL + "' WHERE numch='" + numch + "'");
                    System.out.println("2222222222222222222222");
                }
                catch (Exception e) {
                    this.k = 0;
                ...
                try {
                    ...
                    state2 = conn2.createStatement();
                    pp = "0";
                    state2.executeUpdate("UPDATE   etatdeschequepretmasp SET datevalidation='" + datddd + "' WHERE numch='" + numch + "'");
                    System.out.println("2222222222222222222222");
                    continue;
                }
                catch (Exception e) {
            ...
            try {
                ...
                String pv = "1";
                ResultSet result2 = state2.executeQuery("SELECT * FROM etatdeschequepretmasp  WHERE pv='" + pv + "'");
                ...
                while (result2.next()) {
                    ...
                    try {
                        Class.forName("com.mysql.jdbc.Driver");
                        Statement state3 = conn2.createStatement();
                        ResultSet result3 = state3.executeQuery("SELECT * FROM  cession2  WHERE ncheque='" + numch + "' AND annenbc='" + this.aa.getText() + "'");
                        ResultSetMetaData resultMeta3 = result3.getMetaData();
                        while (result3.next()) {
                            numcs = result3.getString("NBC");
                            annecs = result3.getString("annenbc");
                            medelo.addRow(new Object[]{numcs, annecs, numcarnet, numch, date, mecano, nom, montant, numGL, typecarnet, false});
    ...
    private void tousMouseClicked(MouseEvent evt) {
        ...
        try {
            ...
            Statement state2 = conn2.createStatement();
            String pv = "1";
            ResultSet result2 = state2.executeQuery("SELECT * FROM etatdeschequepretmasp  ORDER BY numch");
            ResultSetMetaData resultMeta2 = result2.getMetaData();
            System.out.println("------------------------------");
            this.k = 0;
            while (result2.next()) {
                ...
                try {
                    ...
                    while (result3.next()) {
                        numcs = result3.getString("NBC");
                        annecs = result3.getString("annenbc");
                        medelo.addRow(new Object[]{numcs, annecs, numcarnet, numch, date, mecano, nom, montant, numGL, typecarnet, b});
                        ColumnsAutoSizer.sizeColumnsToFit(this.ca);
                        ColumnsAutoSizer.sizeColumnsToFit(this.ca);
                    }
                }
    ...
    private void validerMouseClicked(MouseEvent evt) {
        ...
        try {
            ...
            Statement state2 = conn2.createStatement();
            String pv = "0";
            ResultSet result2 = state2.executeQuery("SELECT * FROM etatdeschequepretmasp  WHERE pv='" + pv + "' ORDER BY numch");
            ResultSetMetaData resultMeta2 = result2.getMetaData();
            System.out.println("------------------------------");
            this.k = 0;
            while (result2.next()) {
                ...
                try {
                    ...
                    while (result3.next()) {
                        numcs = result3.getString("NBC");
                        annecs = result3.getString("annenbc");
                        medelo.addRow(new Object[]{numcs, annecs, numcarnet, numch, date, mecano, nom, montant, numGL, typecarnet, true});
                        ColumnsAutoSizer.sizeColumnsToFit(this.ca);
                        ColumnsAutoSizer.sizeColumnsToFit(this.ca);
                    }
                }
