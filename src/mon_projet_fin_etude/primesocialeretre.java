...
public class primesocialeretre
extends JPanel {
    String nomenfant = "";
    String dateenfant = "";
    String numerocheq = "";
    ...
    private void initComponents() {
        ...
        this.mecano.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                primesocialeretre.this.mecanoActionPerformed(evt);
            }
        });
        this.mecano.addKeyListener(new KeyAdapter(){
            ...
            public void keyPressed(KeyEvent evt) {
                primesocialeretre.this.mecanoKeyPressed(evt);
            }

            @Override
            public void keyReleased(KeyEvent evt) {
                primesocialeretre.this.mecanoKeyReleased(evt);
            }
        });
        ...
        this.mont.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesocialeretre.this.montActionPerformed(evt);
            }
        });
        this.mont.addKeyListener(new KeyAdapter(){
            ...
            @Override
            public void keyReleased(KeyEvent evt) {
                primesocialeretre.this.montKeyReleased(evt);
            }
        });
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesocialeretre.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.jLabel27.setBounds(10, 140, 100, 29);
        ...
        this.jLabel30.setBounds(10, 110, 140, 29);
        ...
        this.jTextArea1.addKeyListener(new KeyAdapter(){
            ...
            @Override
            public void keyReleased(KeyEvent evt) {
                primesocialeretre.this.jTextArea1KeyReleased(evt);
            }
        });
        ...
        this.jTextField43.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesocialeretre.this.jTextField43ActionPerformed(evt);
            }
        });
        ...
        this.d2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesocialeretre.this.d2ActionPerformed(evt);
            }
        });
        ...
        this.jTextField46.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesocialeretre.this.jTextField46ActionPerformed(evt);
            }
        });
        ...
        this.jTextField47.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesocialeretre.this.jTextField47ActionPerformed(evt);
            }
        });
        ...
        this.jTextField49.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesocialeretre.this.jTextField49ActionPerformed(evt);
            }
        });
        ...
        this.jTextField51.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesocialeretre.this.jTextField51ActionPerformed(evt);
            }
        });
        ...
        this.jTextField53.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesocialeretre.this.jTextField53ActionPerformed(evt);
            }
        });
        ...
        this.jTextField55.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesocialeretre.this.jTextField55ActionPerformed(evt);
            }
        });
                ...
                if (k) {
                    ...
                    if (deb.equals("")) {
                        ...
                        try {
                            ...
                            state2.executeUpdate("UPDATE  comptecourant SET datedebut='" + datsystem + "' WHERE num='" + this.numcarnet + "'");
                        }
                        catch (Exception e) {
                            k = false;
                            JOptionPane.showMessageDialog(null, "erreur 1" + e.getMessage());
                        ...
                        if (this.Nfin >= this.Nch) {
                            ...
                            if (this.Nfin == this.Nch) {
                                try {
                                    ...
                                    state2.executeUpdate("UPDATE  comptecourant SET datefin='" + datsystem + "' WHERE num='" + this.numcarnet + "'");
                                    k = true;
                                    try {
                                        Class.forName("com.mysql.jdbc.Driver");
                            ...
                            if (this.numcarnetreserver.equals("")) {
                                ...
                                try {
                                    ...
                                    state2 = conn2.createStatement();
                                    p = "0";
                                    state2.executeUpdate("UPDATE  comptecourant SET datedebut='" + datsystem + "' WHERE num='" + this.numcarnetreserver + "'");
                                    k = true;
                                }
                                catch (Exception e) {
                                    k = false;
                    ...
                    if (k) {
                        ...
                        try {
                            ...
                            Statement state = conn23.createStatement();
                    ...
                    try {
                        ...
                        Statement state23 = conn24.createStatement();
                        String p4 = "0";
                        state23.executeUpdate("UPDATE  adherent SET enfant='" + this.nomenfant + "' WHERE MECANO='" + this.mecano.getText() + "'");
                        state23.executeUpdate("UPDATE  adherent SET dateenfant='" + this.dateenfant + "' WHERE MECANO='" + this.mecano.getText() + "'");
                    }
                    catch (Exception e) {
                        k = false;
