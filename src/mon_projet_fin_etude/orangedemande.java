...
extends JPanel {
    ...
    private void initComponents() {
        ...
        this.mec.addKeyListener(new KeyAdapter(){
            ...
            public void keyReleased(KeyEvent evt) {
                orangedemande.this.mecKeyReleased(evt);
            }
        });
        ...
        this.jScrollPane4.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent evt) {
                orangedemande.this.jScrollPane4MouseClicked(evt);
            }
        });
        ...
        this.ca.addMouseListener(new MouseAdapter(){
            ...
            public void mouseEntered(MouseEvent evt) {
                orangedemande.this.caMouseEntered(evt);
            }

            @Override
            public void mouseClicked(MouseEvent evt) {
                orangedemande.this.caMouseClicked(evt);
            }
        });
        this.ca.addAncestorListener(new AncestorListener(){
            ...
            public void ancestorAdded(AncestorEvent evt) {
                orangedemande.this.caAncestorAdded(evt);
            }
        ...
        this.jScrollPane4.setBounds(10, 230, 640, 310);
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                orangedemande.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.jLabel13.setBounds(400, 190, 60, 30);
        ...
        this.jRadioButton4.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                orangedemande.this.jRadioButton4ActionPerformed(evt);
            }
        });
        ...
        this.jLabel18.setText("Observation :");
        this.jPanel1.add(this.jLabel18);
        this.jLabel18.setBounds(10, 110, 110, 30);
        this.nserie.addActionListener(new ActionListener(){

            @Override
            public void actionPerformed(ActionEvent evt) {
                orangedemande.this.nserieActionPerformed(evt);
            }
        });
        this.jPanel1.add(this.nserie);
        this.nserie.setBounds(130, 150, 490, 30);
        this.jLabel19.setFont(new Font("Tahoma", 0, 18));
        this.jLabel19.setForeground(new Color(0, 0, 204));
        this.jLabel19.setText("N\u00b0 Serie :");
        this.jPanel1.add(this.jLabel19);
        this.jLabel19.setBounds(10, 150, 80, 30);
        this.ntelle.setFont(new Font("Tahoma", 0, 14));
        this.jPanel1.add(this.ntelle);
        this.ntelle.setBounds(130, 190, 220, 30);
        this.jLabel20.setFont(new Font("Tahoma", 0, 18));
        this.jLabel20.setForeground(new Color(0, 0, 204));
        this.jLabel20.setText("N\u00b0 Tel :");
        this.jPanel1.add(this.jLabel20);
        this.jLabel20.setBounds(10, 190, 80, 30);
        this.date.setFont(new Font("Tahoma", 1, 12));
        this.jPanel1.add((Component)this.date);
        this.date.setBounds(460, 190, 160, 30);
                    ...
                    for (int i = 0; i < this.ca.getRowCount(); ++i) {
                        ...
                        for (int j = 0; j <= nn; ++j) {
                            ...
                            try {
                                ...
                                state2.executeUpdate("INSERT INTO forfaitdemadeorange(mecano,nomforfait,type,recu,obser,date,ntel,nserie) VALUES('" + this.mec.getText() + "','" + nomf + "','" + type + "','" + p + "','" + this.obs.getText() + "','" + datsystem + "','" + this.ntelle.getText() + "','" + this.nserie.getText() + "')");
                                kk = true;
                                continue;
                            }
                            catch (Exception e) {
    ...
    private void nserieActionPerformed(ActionEvent evt) {
    }
