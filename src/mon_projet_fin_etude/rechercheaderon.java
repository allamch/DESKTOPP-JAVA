...
extends JPanel {
    ...
    private void initComponents() {
        ...
        this.jSeparator4.setBounds(0, 120, 830, 2);
        ...
        this.jScrollPane1.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent evt) {
                rechercheaderon.this.jScrollPane1MouseClicked(evt);
            }
        });
        ...
        this.jTable1.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                rechercheaderon.this.jTable1MouseClicked(evt);
            }

            @Override
            public void mouseEntered(MouseEvent evt) {
                rechercheaderon.this.jTable1MouseEntered(evt);
            }
        });
        this.jTable1.addAncestorListener(new AncestorListener(){
            ...
            public void ancestorAdded(AncestorEvent evt) {
                rechercheaderon.this.jTable1AncestorAdded(evt);
            }
        ...
        this.jButton14.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                rechercheaderon.this.jButton14MouseClicked(evt);
            }
        });
        this.jButton14.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                rechercheaderon.this.jButton14ActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addGap(41, 41, 41).addComponent(this.jLabel12).addGap(31, 31, 31).addComponent(this.jComboBox3, -2, 96, -2).addGap(41, 41, 41).addComponent(this.jTextField1, -2, 133, -2).addGap(18, 18, 18).addComponent(this.jButton14, -2, 81, -2)).addGroup(layout.createSequentialGroup().addContainerGap().addComponent(this.jPanel18, -1, 839, 32767))).addContainerGap()));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.jLabel12, -2, 27, -2).addComponent(this.jComboBox3, -2, -1, -2).addComponent(this.jTextField1, -2, 29, -2)).addComponent(this.jButton14)).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.jPanel18, -1, 569, 32767).addContainerGap()));
            ...
            if (this.jComboBox3.getSelectedItem().equals("N cin")) {
                ...
                try {
                    ...
                    try {
                        ...
                        while (result3.next()) {
                            ...
                            this.jLabel5.setText(result3.getString("NCNR"));
                            ...
                            this.jLabel6.setText(result3.getString("DATNAI"));
                            nom = result3.getString("TEL");
                            this.jLabel11.setText(nom);
                            this.jLabel7.setText(result3.getString("LIEUNAI"));
                            nom = result3.getString("ADRES");
                            this.jLabel18.setText(nom);
                            this.jLabel16.setText(result3.getString("NOMCONJ"));
                        }
                    }
                    catch (Exception e) {
                ...
                try {
                    ...
                    while (result.next()) {
                        ...
                        ResultSetMetaData resultMeta3 = result3.getMetaData();
                        while (result3.next()) {
                            String CNR = result3.getString("CCB");
