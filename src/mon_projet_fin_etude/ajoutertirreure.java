...
public class ajoutertirreure
extends JPanel {
    private String mat;
    private JTextField at;
    private JTextField cint;
    private JTextField delivt;
    ...
    public ajoutertirreure() {
        this.initComponents();
    }

    private void initComponents() {
        this.jPanel1 = new JPanel();
        this.delivt = new JTextField();
        ...
        this.nomt = new JTextField();
        this.jLabel7 = new JLabel();
        this.cint = new JTextField();
        ...
        this.jPanel1.add(this.delivt);
        this.delivt.setBounds(130, 160, 200, 20);
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                ajoutertirreure.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.jButton2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                ajoutertirreure.this.jButton2ActionPerformed(evt);
            }
        });
        this.jPanel1.add(this.jButton2);
        this.jButton2.setBounds(200, 250, 109, 33);
        this.nomt.addActionListener(new ActionListener(){

            @Override
            public void actionPerformed(ActionEvent evt) {
                ajoutertirreure.this.nomtActionPerformed(evt);
            }
        });
        this.jPanel1.add(this.nomt);
        this.nomt.setBounds(130, 90, 200, 20);
        ...
        this.cint.addActionListener(new ActionListener(){

            @Override
            public void actionPerformed(ActionEvent evt) {
                ajoutertirreure.this.cintActionPerformed(evt);
            }
        });
        this.jPanel1.add(this.cint);
        this.cint.setBounds(130, 120, 200, 20);
        this.jLabel4.setFont(new Font("Tahoma", 1, 12));
        this.jLabel4.setText("N\u00b0 C.I.N : *");
        this.jPanel1.add(this.jLabel4);
        this.jLabel4.setBounds(10, 120, 67, 15);
        this.jPanel1.add(this.at);
        this.at.setBounds(130, 200, 200, 20);
        ...
        this.jTextField3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                ajoutertirreure.this.jTextField3ActionPerformed(evt);
            }
        });
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        String nom = this.nomt.getText();
        String cin = this.cint.getText();
        String del = this.delivt.getText();
        String a = this.at.getText();
        try {
            ...
            int b = 1;
            int h = 0;
            state.executeUpdate("UPDATE effectue SET fin='" + h + "' WHERE fin='" + b + "'");
            state.executeUpdate("INSERT INTO effectue(nom,cin,delivre,a,fin) VALUES('" + nom + "','" + cin + "','" + del + "','" + a + "','" + b + "')");
    ...
    private void nomtActionPerformed(ActionEvent evt) {
    }

    private void cintActionPerformed(ActionEvent evt) {
    }
    ...
    private void jButton2ActionPerformed(ActionEvent evt) {
        ...
        int option = JOptionPane.showConfirmDialog(null, "Voulez-vous vraiment Anuller?", "Anuller", 0, 3);
        if (option == 0) {
