...
import mon_projet_fin_etude.caissemaspconsultation;
import mon_projet_fin_etude.caissemaspetat;
import mon_projet_fin_etude.caissemasprechercheparNum;
import mon_projet_fin_etude.caissemasprecherchepardat;
import mon_projet_fin_etude.caissepretetatdecheque;

public class caissemasp
extends JPanel {
    String ch = "";
    String ch1 = "";
    String t;
    ...
    String matt = "";
    String anned = "";
    private caissemaspconsultation caissemaspconsultation1;
    private caissemaspetat caissemaspetat1;
    private caissemasprechercheparNum caissemasprechercheparNum1;
    private caissemasprecherchepardat caissemasprecherchepardat1;
    ...
    private void initComponents() {
        ...
        this.caissemaspconsultation1 = new caissemaspconsultation();
        this.caissemaspetat1 = new caissemaspetat();
        this.caissemasprecherchepardat1 = new caissemasprecherchepardat();
        this.caissemasprechercheparNum1 = new caissemasprechercheparNum();
        ...
        this.jPanel16.add((Component)this.caissemaspconsultation1, "card4");
        this.jPanel16.add((Component)this.caissemaspetat1, "card3");
        this.jPanel16.add((Component)this.caissemasprecherchepardat1, "card2");
        this.jPanel16.add((Component)this.caissemasprechercheparNum1, "card5");
        this.jPanel16.add((Component)this.caissepretetatdecheque1, "card6");
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                caissemasp.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.jButton2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caissemasp.this.jButton2ActionPerformed(evt);
            }
        });
        ...
        this.jButton3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caissemasp.this.jButton3ActionPerformed(evt);
            }
        });
        ...
        this.jButton4.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caissemasp.this.jButton4ActionPerformed(evt);
            }
        });
        ...
        this.jButton6.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caissemasp.this.jButton6ActionPerformed(evt);
            }
        });
