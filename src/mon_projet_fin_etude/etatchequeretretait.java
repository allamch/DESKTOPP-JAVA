...
public class etatchequeretretait
extends JFrame {
    ...
    private void initComponents() {
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                etatchequeretretait.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.jComboBox1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatchequeretretait.this.jComboBox1ActionPerformed(evt);
            }
        });
        ...
        this.jButton2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatchequeretretait.this.jButton2ActionPerformed(evt);
            }
        });
        ...
        this.jButton3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatchequeretretait.this.jButton3ActionPerformed(evt);
            }
        });
        ...
        this.mo.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatchequeretretait.this.moActionPerformed(evt);
            }
        });
        ...
        this.bq.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatchequeretretait.this.bqActionPerformed(evt);
            }
        });
        ...
        this.jButton4.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                etatchequeretretait.this.jButton4ActionPerformed(evt);
            }
        });
    ...
    private void jButton3ActionPerformed(ActionEvent evt) {
        try {
            ...
            String bb = "";
            ResultSet result3 = state.executeQuery("SELECT * FROM etatchequeretr  WHERE mois='" + this.mo.getText() + "'");
            int k = 0;
            while (result3.next()) {
                k = 1;
    ...
    public static void main(String[] args) {
        try {
            ...
            Logger.getLogger(etatchequeretretait.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        EventQueue.invokeLater(new Runnable(){
            ...
            @Override
            public void run() {
                new etatchequeretretait().setVisible(true);
            }
        });
    }
