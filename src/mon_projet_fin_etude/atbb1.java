...
extends JPanel {
    ...
    private void initComponents() {
        ...
        this.nom.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                atbb1.this.nomActionPerformed(evt);
            }
        });
        ...
        this.jTextField11.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                atbb1.this.jTextField11ActionPerformed(evt);
            }
        });
        ...
        this.jTextField14.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                atbb1.this.jTextField14ActionPerformed(evt);
            }
        });
        ...
        this.jTextField15.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                atbb1.this.jTextField15ActionPerformed(evt);
            }
        });
        ...
        this.jTextField4.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                atbb1.this.jTextField4ActionPerformed(evt);
            }
        });
        ...
        this.jTextField3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                atbb1.this.jTextField3ActionPerformed(evt);
            }
        });
        ...
        this.jTextField2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                atbb1.this.jTextField2ActionPerformed(evt);
            }
        });
        ...
        this.jToggleButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                atbb1.this.jToggleButton1ActionPerformed(evt);
            }
        });
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                atbb1.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.jButton2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                atbb1.this.jButton2ActionPerformed(evt);
            }
        });
        ...
        this.jButton3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                atbb1.this.jButton3ActionPerformed(evt);
            }
        });
            ...
            try {
                ...
                try {
                    ...
                    while (result3.next()) {
                        ...
                        System.out.println("************444444444**---------888888888888888888-----------**4444444444*********");
                    }
                }
                catch (Exception e) {
                    JOptionPane.showMessageDialog(null, "erreur : " + e.getMessage());
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        try {
            ...
            ResultSet result = state.executeQuery("SELECT nbm  FROM  adherent WHERE MECANO='" + this.jTextField2.getText() + "'");
            com.mysql.jdbc.ResultSetMetaData resultMeta = (com.mysql.jdbc.ResultSetMetaData)result.getMetaData();
            while (result.next()) {
                this.nbm = result.getInt("nbm");
            }
