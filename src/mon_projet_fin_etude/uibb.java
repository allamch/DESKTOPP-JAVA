    ...
    private void initComponents() {
        ...
        this.jTextField11.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                uibb.this.jTextField11ActionPerformed(evt);
            }
        });
        ...
        this.jTextField3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                uibb.this.jTextField3ActionPerformed(evt);
            }
        });
        ...
        this.jTextField2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                uibb.this.jTextField2ActionPerformed(evt);
            }
        });
        ...
        this.jToggleButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                uibb.this.jToggleButton1ActionPerformed(evt);
            }
        });
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                uibb.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.jButton2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                uibb.this.jButton2ActionPerformed(evt);
            }
        });
        ...
        this.jButton3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                uibb.this.jButton3ActionPerformed(evt);
            }
        });
        ...
        this.jTextField1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                uibb.this.jTextField1ActionPerformed(evt);
            }
        });
        ...
        this.jTextField7.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                uibb.this.jTextField7ActionPerformed(evt);
            }
        });
        ...
        this.jTextField9.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                uibb.this.jTextField9ActionPerformed(evt);
            }
        });
            ...
            try {
                ...
                try {
                    ...
                    while (result3.next()) {
                        ...
                        this.jTextField11.setText(result3.getString("CCB"));
                    }
                }
                catch (Exception e) {
                    JOptionPane.showMessageDialog(null, "erreur : " + e.getMessage());
    ...
    private void jButton2ActionPerformed(ActionEvent evt) {
        ...
        if (this.jTextField2.getText() != "") {
            try {
                ...
                state.executeUpdate("UPDATE adherent SET CCB='" + this.jTextField11.getText() + "' WHERE MECANO=" + this.jTextField2.getText());
