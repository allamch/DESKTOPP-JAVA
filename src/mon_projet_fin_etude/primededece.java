...
extends JPanel {
    ...
    private void initComponents() {
        ...
        this.conj = new JRadioButton();
        this.jLabel30 = new JLabel();
        this.ad = new JRadioButton();
        this.fils = new JRadioButton();
        this.mere = new JRadioButton();
        this.pere = new JRadioButton();
        this.jb = new JRadioButton();
        ...
        this.jLabel1.setText("Prime  D\u00e9c\u00e9s ");
        this.jPanel1.add(this.jLabel1);
        this.jLabel1.setBounds(120, 20, 270, 33);
        this.jLabel2.setIcon(new ImageIcon(this.getClass().getResource("/prime/Colombe2.png")));
        this.jPanel1.add(this.jLabel2);
        this.jLabel2.setBounds(390, 40, 200, 170);
        ...
        this.mecano.addKeyListener(new KeyAdapter(){
            ...
            public void keyPressed(KeyEvent evt) {
                primededece.this.mecanoKeyPressed(evt);
            }

            @Override
            public void keyReleased(KeyEvent evt) {
                primededece.this.mecanoKeyReleased(evt);
            }
        });
        this.jPanel1.add(this.mecano);
        this.mecano.setBounds(100, 70, 90, 30);
        ...
        this.jLabel4.setBounds(200, 70, 80, 24);
        ...
        this.mont.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primededece.this.montActionPerformed(evt);
            }
        });
        this.mont.addKeyListener(new KeyAdapter(){
            ...
            @Override
            public void keyReleased(KeyEvent evt) {
                primededece.this.montKeyReleased(evt);
            }
        });
        this.jPanel1.add(this.mont);
        this.mont.setBounds(280, 70, 100, 30);
        ...
        this.nomadh.setBounds(140, 120, 250, 30);
        this.jButton1.setIcon(new ImageIcon(this.getClass().getResource("/prime/valider2.png")));
        this.jButton1.addActionListener(new ActionListener(){

            @Override
            public void actionPerformed(ActionEvent evt) {
                primededece.this.jButton1ActionPerformed(evt);
            }
        });
        this.jPanel1.add(this.jButton1);
        this.jButton1.setBounds(370, 220, 120, 40);
        this.jButton2.setIcon(new ImageIcon(this.getClass().getResource("/prime/quitter .PNG")));
        this.jPanel1.add(this.jButton2);
        this.jButton2.setBounds(490, 220, 120, 40);
        this.jLabel27.setFont(new Font("Traditional Arabic", 1, 18));
        this.jLabel27.setForeground(new Color(51, 0, 204));
        this.jLabel27.setText(" Le personne d\u00e9c\u00e9d\u00e9e");
        this.jPanel1.add(this.jLabel27);
        this.jLabel27.setBounds(0, 170, 200, 24);
        this.buttonGroup1.add(this.conj);
        this.conj.setFont(new Font("Tahoma", 1, 14));
        this.conj.setText("conjoint");
        this.jPanel1.add(this.conj);
        this.conj.setBounds(200, 230, 93, 25);
        this.jLabel30.setFont(new Font("Traditional Arabic", 1, 18));
        this.jLabel30.setForeground(new Color(51, 0, 204));
        this.jLabel30.setText("Nom adherant :");
        this.jPanel1.add(this.jLabel30);
        this.jLabel30.setBounds(10, 120, 140, 24);
        this.buttonGroup1.add(this.ad);
        this.ad.setFont(new Font("Tahoma", 1, 14));
        this.ad.setText("l'adherent ");
        this.jPanel1.add(this.ad);
        this.ad.setBounds(200, 170, 99, 25);
        this.buttonGroup1.add(this.fils);
        this.fils.setFont(new Font("Tahoma", 1, 14));
        this.fils.setText("fils");
        this.jPanel1.add(this.fils);
        this.fils.setBounds(310, 170, 93, 25);
        this.buttonGroup1.add(this.mere);
        this.mere.setFont(new Font("Tahoma", 1, 14));
        this.mere.setText("m\u00e9re");
        this.jPanel1.add(this.mere);
        this.mere.setBounds(310, 200, 93, 25);
        this.buttonGroup1.add(this.pere);
        this.pere.setFont(new Font("Tahoma", 1, 14));
        this.pere.setText("p\u00e9re");
        this.jPanel1.add(this.pere);
        this.pere.setBounds(200, 200, 93, 25);
        this.buttonGroup1.add(this.jb);
        this.jb.setText("jRadioButton1");
        this.jPanel1.add(this.jb);
        this.jb.setBounds(290, 240, 0, 23);
        ...
        this.jLabel15.setText("Extrait de D\u00e9c\u00e9s");
        ...
        this.jLabel17.setText("d\u00e9c\u00e9s aff\u00e9rente \u00e0 : ");
        this.jPanel2.add(this.jLabel17);
        this.jLabel17.setBounds(10, 240, 120, 17);
        ...
        this.nom.setText(".............................");
        this.jPanel2.add(this.nom);
        this.nom.setBounds(150, 230, 410, 30);
        this.cnr1.setFont(new Font("Tahoma", 1, 14));
        this.cnr1.setText(".............................");
        this.jPanel2.add(this.cnr1);
        this.cnr1.setBounds(80, 300, 190, 17);
        ...
        this.jLabel29.setText("Demande de la prime de d\u00e9c\u00e9s");
        ...
        this.jLabel172.setText("tir\u00e9 sur B.T mahdia a titre de prime de D\u00e9c\u00e9s.");
        ...
        this.jTextField43.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primededece.this.jTextField43ActionPerformed(evt);
            }
        });
        ...
        this.jTextField46.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primededece.this.jTextField46ActionPerformed(evt);
            }
        });
        ...
        this.jTextField47.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primededece.this.jTextField47ActionPerformed(evt);
            }
        });
        ...
        this.jTextField49.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primededece.this.jTextField49ActionPerformed(evt);
            }
        });
        ...
        this.jTextField51.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primededece.this.jTextField51ActionPerformed(evt);
            }
        });
        ...
        this.jTextField53.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primededece.this.jTextField53ActionPerformed(evt);
            }
        });
        ...
        this.jTextField55.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primededece.this.jTextField55ActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addGap(10, 10, 10).addComponent(this.jPanel3, -1, 600, 32767)).addComponent(this.jPanel1, -2, 610, -2)).addContainerGap()));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addComponent(this.jPanel1, -2, 264, -2).addGap(18, 18, 18).addComponent(this.jPanel3, -2, 1438, -2).addContainerGap(-1, 32767)));
    }
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        ...
        if (k) {
            if (this.ad.isSelected()) {
                this.nom.setText("moi meme");
            } else if (this.fils.isSelected()) {
                this.nom.setText(" mon fils");
            } else if (this.mere.isSelected()) {
                this.nom.setText(" ma m\u00e9re");
            } else if (this.pere.isSelected()) {
                this.nom.setText(" mon p\u00e9re");
            } else if (this.conj.isSelected()) {
                this.nom.setText(" mon conjoint");
            }
        }
        if (k) {
