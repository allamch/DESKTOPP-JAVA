...
extends JFrame {
    ...
    private void initComponents() {
        ...
        this.jButton19.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                anciencession.this.jButton19ActionPerformed(evt);
            }
        });
        ...
        this.jButton18.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                anciencession.this.jButton18ActionPerformed(evt);
            }
        });
        ...
        this.mecano.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                anciencession.this.mecanoActionPerformed(evt);
            }
        });
        ...
        this.nbmois.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                anciencession.this.nbmoisActionPerformed(evt);
            }
        });
        ...
        this.numcheque.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                anciencession.this.numchequeActionPerformed(evt);
            }
        });
        ...
        this.mensualit\u00e9.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                anciencession.this.mensualit\u00e9ActionPerformed(evt);
            }
        });
    ...
    public static void main(String[] args) {
        try {
            ...
            Logger.getLogger(anciencession.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        EventQueue.invokeLater(new Runnable(){
            ...
            @Override
            public void run() {
                new anciencession().setVisible(true);
            }
        });
    }
