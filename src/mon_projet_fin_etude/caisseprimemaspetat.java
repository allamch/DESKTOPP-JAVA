...
public class caisseprimemaspetat
extends JPanel {
    String ch = "";
    String ch1 = "";
    String t;
    ...
    private void initComponents() {
        ...
        this.jLabel7.setText("Etat Caisse prime M.A.S.P");
        this.jPanel16.add(this.jLabel7);
        this.jLabel7.setBounds(181, 0, 339, 20);
        ...
        this.ca.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent evt) {
                caisseprimemaspetat.this.caMouseClicked(evt);
            }
        });
        ...
        this.jButton4.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                caisseprimemaspetat.this.jButton4ActionPerformed(evt);
            }
        });
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caisseprimemaspetat.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.jButton2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caisseprimemaspetat.this.jButton2ActionPerformed(evt);
            }
        });
        ...
        this.credit.addKeyListener(new KeyAdapter(){
            ...
            public void keyReleased(KeyEvent evt) {
                caisseprimemaspetat.this.creditKeyReleased(evt);
            }
        });
        ...
        this.jToggleButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caisseprimemaspetat.this.jToggleButton1ActionPerformed(evt);
            }
        });
    ...
    private void jButton4ActionPerformed(ActionEvent evt) {
        ...
        MessageFormat header = new MessageFormat("une Copie de l'etat de Caisse Prime  ");
        MessageFormat footer = new MessageFormat("Page{0,number,integer}");
        try {
            this.ca.print(JTable.PrintMode.FIT_WIDTH, header, footer);
        }
        catch (PrinterException e) {
            System.err.format("Ereure d'mpresstion", e.getMessage());
        }
    }
    ...
    private void jButton2ActionPerformed(ActionEvent evt) {
        if (this.credit.getText().length() < 5) {
            ...
            try {
                ...
                p = "1";
                ResultSet result2 = state2.executeQuery("SELECT * FROM caisseprimemasp  WHERE n='" + p + "'");
                while (result2.next()) {
            ...
            try {
                ...
                String mm = (total += tm) == 0 ? "" + total + "00" : "" + total + "";
                state2.executeUpdate("INSERT INTO caisseprimemasp(date,mecano,debit,credit,total,n) VALUES('" + datsystem + "','','" + prime + "','" + this.credit.getText() + "','" + mm + "','1')");
                this.credit.setText("");
            }
            catch (Exception e) {
                this.k = 0;
            ...
            try {
                ...
                ResultSet result2 = state22.executeQuery("SELECT * FROM caisseprimemasp  ");
                ...
                while (result2.next()) {
                    ...
                    medelo.addRow(new Object[]{date, mecano, NCNR, nom, debit, creditt, totale});
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        ...
        try {
            ...
            ResultSet result2 = state2.executeQuery("SELECT * FROM caisseprimemasp  ");
            ResultSetMetaData resultMeta2 = result2.getMetaData();
            System.out.println("------------------------------");
            while (result2.next()) {
                boolean kk = true;
                ...
                medelo.addRow(new Object[]{date, mecano, NCNR, nom, debit, creditt, total});
                ColumnsAutoSizer.sizeColumnsToFit(this.ca);
                ColumnsAutoSizer.sizeColumnsToFit(this.ca);
            }
        }
        ...
        if (i > 1) {
            ...
            if (option == 0) {
                ...
                try {
                    ...
                    ResultSet result2 = state2.executeQuery("SELECT MAX(netat) FROM caisseprimemasphistorique  ");
                    System.out.println("------------------------------");
                    if (result2.next()) {
                ...
                try {
                    ...
                    while (result2.next()) {
                        ...
                        try {
                            ...
                            state.executeUpdate("INSERT INTO  caisseprimemasphistorique(date,mecano,debit,credit,total,netat,anne) VALUES('" + date + "','" + mecano + "','" + debit + "','" + creditt + "','" + total + "','" + maxnumetat + "','" + ann\u00e9es + "')");
                            this.k = 1;
                        }
                        catch (Exception e) {
                            this.k = 0;
                ...
                if (this.k == 1) {
                    try {
                        Statement state = conn2.createStatement();
                        String n = "0";
                        state.executeUpdate("DELETE  FROM caisseprimemasp WHERE n='" + n + "'");
                        try {
                            Class.forName("com.mysql.jdbc.Driver");
                            Statement state2 = conn2.createStatement();
                            state2.executeUpdate("UPDATE  caisseprimemasp SET mecano=''");
                            state2.executeUpdate("UPDATE  caisseprimemasp SET debit='0'");
                            state2.executeUpdate("UPDATE  caisseprimemasp SET credit='0'");
                            this.k = 1;
                        }
                        catch (Exception e) {
                            this.k = 0;
