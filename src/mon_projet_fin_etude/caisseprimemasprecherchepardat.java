...
public class caisseprimemasprecherchepardat
extends JPanel {
    String ch = "";
    String ch1 = "";
    String t;
    ...
    public caisseprimemasprecherchepardat() {
        this.initComponents();
    }
    ...
    private void initComponents() {
        ...
        this.jScrollPane1.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent evt) {
                caisseprimemasprecherchepardat.this.jScrollPane1MouseClicked(evt);
            }
        });
        this.ca.setFont(new Font("Tahoma", 0, 12));
        this.ca.setModel(new DefaultTableModel(new Object[][]{{null, null, null, null, null, null, null}, {null, null, null, null, null, null, null}, {null, null, null, null, null, null, null}, {null, null, null, null, null, null, null}, {null, null, null, null, null, null, null}}, new String[]{"Date", "Mecano", "N\u00b0 CNR", "Nom et prenom", "Debit", "Credit", "Total"}){
            Class[] types;
            {
                //super(x0, x1);
        ...
        this.ca.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseprimemasprecherchepardat.this.caMouseClicked(evt);
            }

            @Override
            public void mouseEntered(MouseEvent evt) {
                caisseprimemasprecherchepardat.this.caMouseEntered(evt);
            }
        });
        this.ca.addAncestorListener(new AncestorListener(){
            ...
            public void ancestorAdded(AncestorEvent evt) {
                caisseprimemasprecherchepardat.this.caAncestorAdded(evt);
            }
        ...
        this.jLabel7.setText("Consultation de l'historique de Caisse Prime MASP par date ");
        this.jPanel16.add(this.jLabel7);
        this.jLabel7.setBounds(0, 0, 770, 30);
        ...
        this.m1.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseprimemasprecherchepardat.this.m1MouseClicked(evt);
            }
        });
        this.m1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                caisseprimemasprecherchepardat.this.m1ActionPerformed(evt);
            }
        });
        ...
        this.m2.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseprimemasprecherchepardat.this.m2MouseClicked(evt);
            }

            @Override
            public void mouseEntered(MouseEvent evt) {
                caisseprimemasprecherchepardat.this.m2MouseEntered(evt);
            }
        });
        ...
        this.a2.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseprimemasprecherchepardat.this.a2MouseClicked(evt);
            }
        });
        ...
        this.a1.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseprimemasprecherchepardat.this.a1MouseClicked(evt);
            }
        });
        ...
        this.j2.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseprimemasprecherchepardat.this.j2MouseClicked(evt);
            }
        });
        ...
        this.j1.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseprimemasprecherchepardat.this.j1MouseClicked(evt);
            }
        });
        ...
        this.jTextField2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caisseprimemasprecherchepardat.this.jTextField2ActionPerformed(evt);
            }
        });
        ...
        this.dd.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseprimemasprecherchepardat.this.ddMouseClicked(evt);
            }
        });
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caisseprimemasprecherchepardat.this.jButton1ActionPerformed(evt);
            }
        });
    ...
    private void m1MouseClicked(MouseEvent evt) {
        if (this.dd.isSelected()) {
            ...
            try {
                ...
                ResultSet result2 = state2.executeQuery("SELECT *  FROM   caisseprimemasphistorique ");
                ...
                while (result2.next()) {
                    ...
                    if (!(debit = result2.getString("debit")).equals("0")) {
                    ...
                    medelo.addRow(new Object[]{dt, Mec, cnr, nom, debit, credit, total});
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        MessageFormat header = new MessageFormat("historique de caisse prime masp par date  ");
