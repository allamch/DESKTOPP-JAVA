...
public class caisseprimescolaireetatdecheque
extends JPanel {
    String ch = "";
    String ch1 = "";
    String t;
    ...
    public caisseprimescolaireetatdecheque() {
        this.initComponents();
    }
    ...
    private void initComponents() {
        ...
        this.jLabel7.setText("Etat des cheques Prime scolaire");
        this.jPanel16.add(this.jLabel7);
        this.jLabel7.setBounds(180, 0, 430, 30);
        ...
        this.ca.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent evt) {
                caisseprimescolaireetatdecheque.this.caMouseClicked(evt);
            }
        });
        this.jScrollPane1.setViewportView(this.ca);
        this.jPanel16.add(this.jScrollPane1);
        this.jScrollPane1.setBounds(10, 50, 820, 460);
        ...
        this.jButton4.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                caisseprimescolaireetatdecheque.this.jButton4ActionPerformed(evt);
            }
        });
        this.jPanel16.add(this.jButton4);
        this.jButton4.setBounds(590, 20, 120, 30);
        ...
        this.jButton2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caisseprimescolaireetatdecheque.this.jButton2ActionPerformed(evt);
            }
        });
        this.jPanel16.add(this.jButton2);
        this.jButton2.setBounds(720, 20, 110, 30);
        ...
        this.tous.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseprimescolaireetatdecheque.this.tousMouseClicked(evt);
            }
        });
        ...
        this.valider.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseprimescolaireetatdecheque.this.validerMouseClicked(evt);
            }
        });
        ...
        this.nonvalider.addMouseListener(new MouseAdapter(){
            ...
            @Override
            public void mouseClicked(MouseEvent evt) {
                caisseprimescolaireetatdecheque.this.nonvaliderMouseClicked(evt);
            }
        });
        this.nonvalider.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caisseprimescolaireetatdecheque.this.nonvaliderActionPerformed(evt);
            }
        });
        ...
        this.jPanel16.setBounds(0, 0, 840, 520);
    }
    ...
    private void jButton4ActionPerformed(ActionEvent evt) {
        if (this.tous.isSelected()) {
            ...
            MessageFormat header = new MessageFormat("Liste des tous les cheques des primes scolaires");
            ...
            SimpleDateFormat dateFormattddc = new SimpleDateFormat("dd/MM/yyyy");
            String dat = dateFormattddc.format(actuellEeddc);
            MessageFormat header = new MessageFormat("Liste des cheques primes scolaires valider");
            MessageFormat footer = new MessageFormat("Page{0,number,integer}");
            try {
                this.ca.print(JTable.PrintMode.FIT_WIDTH, header, footer);
            }
            ...
            SimpleDateFormat dateFormattddc = new SimpleDateFormat("dd/MM/yyyy");
            String dat = dateFormattddc.format(actuellEeddc);
            MessageFormat header = new MessageFormat("Liste des cheques primes scolaires non valider");
            MessageFormat footer = new MessageFormat("Page{0,number,integer}");
            try {
                this.ca.print(JTable.PrintMode.FIT_WIDTH, header, footer);
            }
        ...
        if (this.nonvalider.isSelected()) {
            ...
            for (int i = 0; i < this.ca.getRowCount(); ++i) {
                ...
                try {
                    ...
                    pp = "0";
                    state2.executeUpdate("UPDATE   primescolaire SET pv='" + pp + "' WHERE numch='" + numch + "'");
                ...
                try {
                    ...
                    state2 = conn2.createStatement();
                    pp = "0";
                    state2.executeUpdate("UPDATE   primescolaire SET numGL='" + numGL + "' WHERE numch='" + numch + "'");
                    System.out.println("2222222222222222222222");
                }
                catch (Exception e) {
                    this.k = 0;
                ...
                try {
                    ...
                    state2 = conn2.createStatement();
                    pp = "0";
                    state2.executeUpdate("UPDATE   primescolaire SET datevalidation='" + datddd + "' WHERE numch='" + numch + "'");
                    System.out.println("2222222222222222222222");
                    continue;
                }
                catch (Exception e) {
            ...
            try {
                ...
                String pv = "1";
                ResultSet result2 = state2.executeQuery("SELECT * FROM primescolaire  WHERE pv='" + pv + "'");
    ...
    private void tousMouseClicked(MouseEvent evt) {
        ...
        try {
            ...
            Statement state2 = conn2.createStatement();
            String pv = "1";
            ResultSet result2 = state2.executeQuery("SELECT * FROM primescolaire  ORDER BY num");
            ResultSetMetaData resultMeta2 = result2.getMetaData();
            System.out.println("------------------------------");
            this.k = 0;
            while (result2.next()) {
