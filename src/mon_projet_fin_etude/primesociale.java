...
extends JPanel {
    ...
    private void initComponents() {
        ...
        this.jLabel1.setText("Aide sociale");
        this.jPanel1.add(this.jLabel1);
        this.jLabel1.setBounds(158, 20, 290, 33);
        this.jLabel2.setIcon(new ImageIcon(this.getClass().getResource("/prime/sociale.png")));
        this.jPanel1.add(this.jLabel2);
        this.jLabel2.setBounds(430, 20, 180, 170);
        ...
        this.mecano.addKeyListener(new KeyAdapter(){
            ...
            public void keyPressed(KeyEvent evt) {
                primesociale.this.mecanoKeyPressed(evt);
            }

            @Override
            public void keyReleased(KeyEvent evt) {
                primesociale.this.mecanoKeyReleased(evt);
            }
        });
        ...
        this.jLabel4.setBounds(210, 70, 100, 24);
        ...
        this.mont.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesociale.this.montActionPerformed(evt);
            }
        });
        this.mont.addKeyListener(new KeyAdapter(){
            ...
            @Override
            public void keyReleased(KeyEvent evt) {
                primesociale.this.montKeyReleased(evt);
            }
        });
        this.jPanel1.add(this.mont);
        this.mont.setBounds(310, 70, 100, 30);
        ...
        this.jLabel30.setBounds(10, 110, 140, 24);
        ...
        this.jTextArea1.addKeyListener(new KeyAdapter(){
            ...
            @Override
            public void keyReleased(KeyEvent evt) {
                primesociale.this.jTextArea1KeyReleased(evt);
            }
        });
        this.jScrollPane1.setViewportView(this.jTextArea1);
        this.jPanel1.add(this.jScrollPane1);
        this.jScrollPane1.setBounds(110, 140, 250, 100);
        ...
        this.jLabel8.setBounds(10, 340, 130, 17);
        ...
        this.jLabel29.setText("Demande  d'aide  sociale");
        ...
        this.jPanel22.setBounds(400, 440, 140, 110);
        this.jLabel19.setFont(new Font("Tahoma", 0, 14));
        this.jLabel19.setText("N\u00b0 CNR :");
        this.jPanel2.add(this.jLabel19);
        this.jLabel19.setBounds(10, 370, 60, 17);
        this.jTextArea2.setColumns(20);
        this.jTextArea2.setRows(5);
        this.jScrollPane2.setViewportView(this.jTextArea2);
        this.jPanel2.add(this.jScrollPane2);
        this.jScrollPane2.setBounds(100, 226, 470, 100);
        this.jPanel3.add(this.jPanel2);
        this.jPanel2.setBounds(0, 20, 590, 550);
        ...
        this.jLabel172.setText("tir\u00e9 sur B.T mahdia a titre subvention sociale.");
        ...
        this.jTextField43.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesociale.this.jTextField43ActionPerformed(evt);
            }
        });
        ...
        this.d2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesociale.this.d2ActionPerformed(evt);
            }
        });
        ...
        this.jTextField46.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesociale.this.jTextField46ActionPerformed(evt);
            }
        });
        ...
        this.jTextField47.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesociale.this.jTextField47ActionPerformed(evt);
            }
        });
        ...
        this.jTextField49.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesociale.this.jTextField49ActionPerformed(evt);
            }
        });
        ...
        this.jTextField51.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesociale.this.jTextField51ActionPerformed(evt);
            }
        });
        ...
        this.jTextField53.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesociale.this.jTextField53ActionPerformed(evt);
            }
        });
        ...
        this.jTextField55.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                primesociale.this.jTextField55ActionPerformed(evt);
            }
        });
        ...
        this.ETATPRIME.setBounds(10, 570, 580, 720);
        ...
        this.jPanel4.setBounds(30, 1310, 420, 190);
        ...
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addComponent(this.jPanel1, -2, 251, -2).addGap(31, 31, 31).addComponent(this.jPanel3, -2, 1509, -2).addContainerGap(-1, 32767)));
    }
    ...
    private void jTextArea1KeyReleased(KeyEvent evt) {
        this.jTextArea2.setToolTipText(this.jTextArea1.getText());
    }
