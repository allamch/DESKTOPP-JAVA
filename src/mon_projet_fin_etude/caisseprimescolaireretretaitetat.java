...
public class caisseprimescolaireretretaitetat
extends JPanel {
    String ch = "";
    String ch1 = "";
    String t;
    ...
    public caisseprimescolaireretretaitetat() {
        this.initComponents();
    }
    ...
    private void initComponents() {
        ...
        this.jLabel7.setBounds(180, 0, 350, 20);
        ...
        this.ca.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent evt) {
                caisseprimescolaireretretaitetat.this.caMouseClicked(evt);
            }
        });
        ...
        this.jButton4.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                caisseprimescolaireretretaitetat.this.jButton4ActionPerformed(evt);
            }
        });
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caisseprimescolaireretretaitetat.this.jButton1ActionPerformed(evt);
            }
        });
        ...
        this.jButton2.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caisseprimescolaireretretaitetat.this.jButton2ActionPerformed(evt);
            }
        });
        ...
        this.credit.addKeyListener(new KeyAdapter(){
            ...
            public void keyReleased(KeyEvent evt) {
                caisseprimescolaireretretaitetat.this.creditKeyReleased(evt);
            }
        });
        ...
        this.jToggleButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                caisseprimescolaireretretaitetat.this.jToggleButton1ActionPerformed(evt);
            }
        });
    ...
    private void jButton4ActionPerformed(ActionEvent evt) {
        ...
        MessageFormat header = new MessageFormat("une Copie de l'etat de Caisse Prime Scolaire Ret");
    ...
    private void jButton2ActionPerformed(ActionEvent evt) {
        if (this.credit.getText().length() < 5) {
            ...
            try {
                ...
                p = "1";
                ResultSet result2 = state2.executeQuery("SELECT * FROM caisseprimescolaireretretait  WHERE n='" + p + "'");
                while (result2.next()) {
            ...
            try {
                ...
                p = "0";
                state2.executeUpdate("UPDATE  caisseprimescolaireretretait SET n='0' ");
                this.k = 1;
            }
            catch (Exception e) {
                this.k = 0;
            ...
            try {
                ...
                String mm = "" + (total += tm) + "";
                state2.executeUpdate("INSERT INTO caisseprimescolaireretretait(date,mecano,debit,credit,total,n) VALUES('" + datsystem + "','','" + d + "','" + this.credit.getText() + "','" + mm + "','1')");
                this.credit.setText("");
            }
            catch (Exception e) {
                this.k = 0;
            ...
            try {
                ...
                ResultSet result2 = state22.executeQuery("SELECT * FROM  caisseprimescolaireretretait  ");
                ...
                while (result2.next()) {
                    ...
                    String annescoaie = result2.getString("annescolaire");
                    if (mecano.equals("")) {
                        kk = false;
                    }
                    if (kk) {
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        ...
        try {
            ...
            ResultSet result2 = state2.executeQuery("SELECT * FROM  caisseprimescolaireretretait  ");
            ResultSetMetaData resultMeta2 = result2.getMetaData();
            System.out.println("------------------------------");
            while (result2.next()) {
                boolean kk = true;
                ...
                medelo.addRow(new Object[]{num, annescoaie, date, mecano, NCNR, nom, debit, credit, total});
                ColumnsAutoSizer.sizeColumnsToFit(this.ca);
                ColumnsAutoSizer.sizeColumnsToFit(this.ca);
            }
        }
        ...
        if (i > 1) {
            ...
            if (option == 0) {
                ...
                try {
                    ...
                    ResultSet result2 = state2.executeQuery("SELECT MAX(netat) FROM historiquecaisseprimescolireret ");
                    System.out.println("------------------------------");
                    if (result2.next()) {
                ...
                try {
                    ...
                    while (result2.next()) {
                        ...
                        try {
                            ...
                            state.executeUpdate("INSERT INTO historiquecaisseprimescolireret(date,mecano,debit,credit,total,netat,anne) VALUES('" + date + "','" + mecano + "','" + debit + "','" + credit + "','" + total + "','" + maxnumetat + "','" + ann\u00e9es + "')");
                            this.k = 1;
                        }
                        catch (Exception e) {
                            this.k = 0;
                ...
                if (this.k == 1) {
                    try {
                        Statement state = conn2.createStatement();
                        String n = "0";
                        state.executeUpdate("DELETE  FROM caisseprimescolaireretretait WHERE n='" + n + "'");
                        try {
                            Class.forName("com.mysql.jdbc.Driver");
                            Statement state2 = conn2.createStatement();
                            state2.executeUpdate("UPDATE  caisseprimescolaireretretait SET mecano=''");
                            state2.executeUpdate("UPDATE  caisseprimescolaireretretait SET debit='0'");
                            state2.executeUpdate("UPDATE  caisseprimescolaireretretait SET credit='0'");
                            this.k = 1;
                        }
                        catch (Exception e) {
                            this.k = 0;
