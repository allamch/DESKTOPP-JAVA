...
extends JPanel {
    ...
    private JLabel agenceauto;
    private JLabel banqueau;
    private JPanel cheque10;
    private JLabel cinauto;
    ...
    private JLabel montanparmoisautorisation;
    ...
    private void initComponents() {
        ...
        this.cinauto = new JLabel();
        this.delivleauto = new JLabel();
        this.ribauto = new JLabel();
        this.jLabel101 = new JLabel();
        this.agenceauto = new JLabel();
        this.banqueau = new JLabel();
        ...
        this.montanparmoisautorisation = new JLabel();
        ...
        this.jLabel1.setText("TUNIS");
        this.jPanel1.add(this.jLabel1);
        this.jLabel1.setBounds(0, 130, 110, 30);
        ...
        this.mecano.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent evt) {
                Autorisation.this.mecanoActionPerformed(evt);
            }
        });
        ...
        this.jLabel3.setBounds(210, 80, 90, 30);
        ...
        this.nbmois.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                Autorisation.this.nbmoisActionPerformed(evt);
            }
        });
        ...
        this.mensualit\u00e9.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                Autorisation.this.mensualit\u00e9ActionPerformed(evt);
            }
        });
        ...
        this.jButton1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                Autorisation.this.jButton1ActionPerformed(evt);
            }
        });
        this.jPanel1.add(this.jButton1);
        this.jButton1.setBounds(400, 80, 160, 40);
        ...
        this.jButton6.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                Autorisation.this.jButton6ActionPerformed(evt);
            }
        });
        ...
        this.mat.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                Autorisation.this.matActionPerformed(evt);
            }
        });
        this.jPanel1.add(this.mat);
        this.mat.setBounds(300, 80, 80, 30);
        ...
        this.jButton3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                Autorisation.this.jButton3ActionPerformed(evt);
            }
        });
        this.jPanel1.add(this.jButton3);
        this.jButton3.setBounds(330, 120, 120, 40);
        this.jLabel5.setFont(new Font("Tahoma", 1, 30));
        this.jLabel5.setForeground(new Color(51, 51, 255));
        this.jLabel5.setText("Autorisation de prelevement d'office");
        this.jPanel1.add(this.jLabel5);
        this.jLabel5.setBounds(10, 0, 570, 30);
        ...
        this.jLabel15.setBounds(370, 20, 190, 14);
        this.jLabel33.setFont(new Font("Tahoma", 0, 14));
        this.jLabel33.setText("Je soussign\u00e9 Mr:");
        this.jPanel4.add(this.jLabel33);
        this.jLabel33.setBounds(20, 170, 110, 30);
        this.jLabel35.setFont(new Font("Tahoma", 0, 14));
        this.jLabel35.setText("d\u00e9livr\u00e9e le");
        this.jPanel4.add(this.jLabel35);
        this.jLabel35.setBounds(10, 200, 70, 30);
        this.jLabel36.setFont(new Font("Tahoma", 0, 14));
        this.jLabel36.setText("Ayant un compte Bancaire dont le RIB ");
        this.jPanel4.add(this.jLabel36);
        this.jLabel36.setBounds(250, 200, 280, 30);
        this.jLabel37.setFont(new Font("Tahoma", 0, 14));
        this.jLabel37.setText("pendant");
        this.jPanel4.add(this.jLabel37);
        this.jLabel37.setBounds(10, 290, 60, 17);
        this.jLabel38.setFont(new Font("Tahoma", 0, 14));
        this.jLabel38.setText("dinars");
        this.jPanel4.add(this.jLabel38);
        this.jLabel38.setBounds(480, 260, 50, 20);
        this.jLabel39.setFont(new Font("Tahoma", 0, 14));
        this.jLabel39.setText("par la pr\u00e9sente demande");
        this.jPanel4.add(this.jLabel39);
        this.jLabel39.setBounds(380, 230, 160, 20);
        this.jLabel40.setFont(new Font("Tahoma", 0, 14));
        this.jLabel40.setText("el m\u00e9dina tunis \u00e0 partir du ");
        this.jPanel4.add(this.jLabel40);
        this.jLabel40.setBounds(10, 350, 170, 30);
        this.jLabel41.setFont(new Font("Tahoma", 0, 14));
        this.jLabel41.setText("de la somme re\u00e7ue au dit \u00e9tablissement .");
        this.jPanel4.add(this.jLabel41);
        this.jLabel41.setBounds(20, 480, 490, 30);
        this.nometprenom.setFont(new Font("Tahoma", 1, 14));
        this.nometprenom.setText("...............................................................");
        this.jPanel4.add(this.nometprenom);
        this.nometprenom.setBounds(120, 170, 180, 30);
        this.jLabel58.setFont(new Font("Tahoma", 0, 14));
        this.jLabel58.setText("Signature du b\u00e9n\u00e9ficiaire");
        this.jPanel4.add(this.jLabel58);
        this.jLabel58.setBounds(340, 550, 170, 20);
        this.jLabel62.setFont(new Font("Tahoma", 0, 14));
        this.jLabel62.setText("b\u00e9n\u00e9ficiaire est ouvert \u00e0 la STB sous le Num\u00e9ro 10005036186889778842 . \u00e0 l'agence");
        this.jPanel4.add(this.jLabel62);
        this.jLabel62.setBounds(10, 320, 530, 20);
        ...
        this.nbbmois.setBounds(80, 290, 70, 20);
        this.jLabel70.setFont(new Font("Tahoma", 0, 14));
        this.jLabel70.setText("(l\u00e9galis\u00e9e)");
        this.jPanel4.add(this.jLabel70);
        this.jLabel70.setBounds(380, 570, 60, 17);
        this.jLabel71.setFont(new Font("Tahoma", 0, 14));
        this.jLabel71.setText("mois au profit de la mutuelle des retrait\u00e9s dont le compte ");
        this.jPanel4.add(this.jLabel71);
        this.jLabel71.setBounds(160, 290, 380, 20);
        this.date1.setFont(new Font("Tahoma", 1, 14));
        this.date1.setText(".....................................................");
        this.jPanel4.add(this.date1);
        this.date1.setBounds(190, 350, 180, 30);
        this.jLabel99.setFont(new Font("Tahoma", 0, 14));
        this.jLabel99.setText("\u00e0");
        this.jPanel4.add(this.jLabel99);
        this.jLabel99.setBounds(270, 220, 20, 40);
        this.jLabel100.setFont(new Font("Tahoma", 0, 14));
        this.jLabel100.setText("Titulaire de n\u00b0 CIN:");
        this.jPanel4.add(this.jLabel100);
        this.jLabel100.setBounds(300, 170, 120, 30);
        ...
        this.jLabel68.setText("de la banque");
        this.jPanel4.add(this.jLabel68);
        this.jLabel68.setBounds(60, 590, 90, 20);
        this.dateatt.setFont(new Font("Tahoma", 1, 12));
        this.dateatt.setText("..................");
        this.jPanel4.add(this.dateatt);
        this.dateatt.setBounds(110, 60, 140, 20);
        this.jLabel42.setFont(new Font("Tahoma", 0, 14));
        this.jLabel42.setText("Tunis le :");
        this.jPanel4.add(this.jLabel42);
        this.jLabel42.setBounds(50, 60, 70, 20);
        this.cinauto.setFont(new Font("Tahoma", 1, 14));
        this.cinauto.setText("............");
        this.jPanel4.add(this.cinauto);
        this.cinauto.setBounds(430, 170, 120, 30);
        this.delivleauto.setFont(new Font("Tahoma", 1, 14));
        this.delivleauto.setText("............");
        this.jPanel4.add(this.delivleauto);
        this.delivleauto.setBounds(80, 200, 140, 30);
        this.ribauto.setFont(new Font("Tahoma", 1, 14));
        this.ribauto.setText("...............................................................");
        this.jPanel4.add(this.ribauto);
        this.ribauto.setBounds(10, 230, 260, 20);
        this.jLabel101.setFont(new Font("Tahoma", 0, 14));
        this.jLabel101.setText("\u00e0 ex\u00e9cuter les pr\u00e9l\u00e9vements de");
        this.jPanel4.add(this.jLabel101);
        this.jLabel101.setBounds(150, 250, 200, 30);
        this.agenceauto.setFont(new Font("Tahoma", 1, 14));
        this.agenceauto.setText("............");
        this.jPanel4.add(this.agenceauto);
        this.agenceauto.setBounds(290, 230, 80, 20);
        this.banqueau.setFont(new Font("Tahoma", 1, 14));
        this.banqueau.setText("............");
        this.jPanel4.add(this.banqueau);
        this.banqueau.setBounds(90, 250, 70, 30);
        this.jLabel44.setFont(new Font("Tahoma", 0, 14));
        this.jLabel44.setText("ma Banque");
        this.jPanel4.add(this.jLabel44);
        this.jLabel44.setBounds(10, 260, 70, 17);
        this.jLabel45.setFont(new Font("Tahoma", 0, 14));
        this.jLabel45.setText("Je m'engage \u00e0 n'effectuer aucune opposition sur les pr\u00e9l\u00e9vements sus-inqiqu\u00e9es ");
        this.jPanel4.add(this.jLabel45);
        this.jLabel45.setBounds(30, 390, 490, 30);
        this.jLabel46.setFont(new Font("Tahoma", 0, 14));
        this.jLabel46.setText("et \u00e0 provisionner p\u00e9riodiquement mon compte pour assurer l'ex\u00e9cution des dits ");
        this.jPanel4.add(this.jLabel46);
        this.jLabel46.setBounds(20, 420, 490, 30);
        this.jLabel47.setFont(new Font("Tahoma", 0, 14));
        this.jLabel47.setText("pr\u00e9l\u00e9vements et \u00e0 ne pas changer mon compte qu'apr\u00e9s payement de la totalit\u00e9");
        this.jPanel4.add(this.jLabel47);
        this.jLabel47.setBounds(20, 450, 490, 30);
        this.jLabel69.setFont(new Font("Tahoma", 0, 14));
        this.jLabel69.setText("Accord pour ex\u00e9cution");
        this.jPanel4.add(this.jLabel69);
        this.jLabel69.setBounds(40, 550, 140, 20);
        this.jLabel102.setFont(new Font("Tahoma", 0, 14));
        this.jLabel102.setText("Signature et cachet");
        this.jPanel4.add(this.jLabel102);
        this.jLabel102.setBounds(40, 570, 140, 17);
        this.montanparmoisautorisation.setFont(new Font("Tahoma", 1, 14));
        this.montanparmoisautorisation.setText("............");
        this.jPanel4.add(this.montanparmoisautorisation);
        this.montanparmoisautorisation.setBounds(370, 250, 100, 30);
        ...
        this.dateetat.setBounds(10, 150, 50, 30);
        ...
        this.matriculeetat.setBounds(390, 310, 180, 30);
        ...
        this.jTextField1.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                Autorisation.this.jTextField1ActionPerformed(evt);
            }
        });
        ...
        this.jTextField3.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                Autorisation.this.jTextField3ActionPerformed(evt);
            }
        });
        ...
        this.jTextField4.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                Autorisation.this.jTextField4ActionPerformed(evt);
            }
        });
        ...
        this.jTextField5.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                Autorisation.this.jTextField5ActionPerformed(evt);
            }
        });
        ...
        this.jTextField7.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                Autorisation.this.jTextField7ActionPerformed(evt);
            }
        });
        ...
        this.jTextField9.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                Autorisation.this.jTextField9ActionPerformed(evt);
            }
        });
        ...
        this.jTextField11.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent evt) {
                Autorisation.this.jTextField11ActionPerformed(evt);
            }
        });
        ...
        this.jPanel8.setBounds(0, 10, 580, 770);
        ...
        jPanel10Layout.setVerticalGroup(jPanel10Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGap(0, 310, 32767).addGroup(jPanel10Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel10Layout.createSequentialGroup().addGap(0, 0, 32767).addComponent(this.jPanel11, -2, 310, -2).addGap(0, 0, 32767))));
        ...
        jPanel13Layout.setVerticalGroup(jPanel13Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, jPanel13Layout.createSequentialGroup().addComponent(this.cheque10, -2, 217, -2).addContainerGap(22, 32767)));
        GroupLayout jPanel2Layout = new GroupLayout(this.jPanel2);
        this.jPanel2.setLayout(jPanel2Layout);
        jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel2Layout.createSequentialGroup().addContainerGap().addGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jPanel4, -1, 592, 32767).addGroup(jPanel2Layout.createSequentialGroup().addGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jPanel1, -2, 582, -2).addComponent(this.jPanel13, -2, 537, -2).addComponent(this.jPanel10, -2, -1, -2).addComponent(this.jPanel7, -1, 582, 32767).addComponent(this.jPanel3, -2, 558, -2)).addContainerGap()))));
        jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel2Layout.createSequentialGroup().addContainerGap().addComponent(this.jPanel1, -2, 166, -2).addGap(26, 26, 26).addComponent(this.jPanel4, -2, 783, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jPanel3, -2, 361, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jPanel7, -2, 373, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.jPanel10, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.jPanel13, -1, -1, 32767)));
        ...
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addComponent(this.jPanel2, -2, -1, -2).addContainerGap(439, 32767)));
    }
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        ...
        this.montanparmoisautorisation.setText(this.parmois);
        int tt = ss.length() - 3;
        ...
        try {
            ...
            Logger.getLogger(Autorisation.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        if (this.k == 1) {
            ...
            try {
                ...
                String p = "1";
                ResultSet result2 = state2.executeQuery("SELECT * FROM autorisation WHERE annenbc='" + aaa + "'");
                        ...
                        if (this.Nfin >= this.Nch) {
                            ...
                            if (this.Nfin == this.Nch) {
                                try {
                                    ...
                                    try {
                                        ...
                                        Statement state22 = conn222.createStatement();
                                        System.out.println("numero de carnet de cheque  =" + this.numcarnet);
                            ...
                            if (this.k == 1) {
                                try {
                                    ...
                                    String mdi = di + "000";
                                    String p4 = "1";
                                    state23.executeUpdate("INSERT INTO talondescheque(numcheque,Numcarnet,Mecano,Montant,date,type,p,banque) VALUES('" + this.firstcheque + "','" + this.numcarnet + "','" + this.mecano.getText() + "','" + mdi + "','" + datdd + "','" + typcarnet + "','" + p4 + "','" + ba + "')");
                                    this.k = 1;
                                }
                                catch (Exception e) {
                                    this.k = 0;
                            ...
                            if (this.numcarnetreserver.equals("")) {
                                ...
                                try {
                                    ...
                                    String mmff = "000";
                                    String p5 = "1";
                                    state2.executeUpdate("INSERT INTO talondescheque(numcheque,Numcarnet,Mecano,Montant,date,type,p,banque) VALUES('" + this.firstcheque + "','" + this.numcarnetreserver + "','" + this.mecano.getText() + "','" + mmff + "','" + datdd + "','" + typcarnet + "','" + p5 + "','" + ba + "')");
                                    this.k = 1;
                    ...
                    try {
                        ...
                        try {
                            ...
                            while (result3.next()) {
                                ...
                                this.agenceauto.setText(result3.getString("agence"));
                                this.banqueau.setText(result3.getString("banque"));
                            }
                        }
                        catch (Exception e) {
                ...
                if (this.k == 1) {
                    ...
                    if (option == 0) {
                        ...
                        try {
                            ...
                            this.k = 1;
                            String p = "0";
                            state2.executeUpdate("INSERT INTO autorisation(NBM,annenbc,mois,date,Mecano,Nom,Montant,Nbmois,premiermois,derniermois,montantparmois,ncheque,pv) VALUES('" + this.num + "','" + aaa + "','" + dateS + "','" + datddd + "','" + this.mecano.getText() + "','" + this.nomadh + "','" + montglobale + "','" + nbm + "','" + moiddebut + "','" + moisfin + "','" + this.parmois + "','" + this.firstcheque + "','" + p + "')");
                        }
                        catch (Exception e) {
                            this.k = 0;
                            jop1 = new JOptionPane();
